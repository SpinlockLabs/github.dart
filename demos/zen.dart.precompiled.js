...
["github.common", "package:github/common.dart", , T, {
  ...
  MiscService: {
    "^": "Service;_github",
    getZen$0: function() {
      return this._github.request$2(0, "GET", "/zen").then$1(new T.MiscService_getZen_closure());
    }
  },
  MiscService_getZen_closure: {
    "^": "Closure:10;",
...
["", "zen.dart", , V, {
  ...
  loadZen: function() {
    ...
    if (t2 == null) {
      ...
      t1 = t2;
    t1.getZen$0().then$1(new V.loadZen_closure());
  },
  main_closure: {
    "^": "Closure:8;",
    call$0: function() {
...
function dart_precompiled($collectedClasses) {
  ...
  function MiscService_getZen_closure() {
  }
  MiscService_getZen_closure.builtin$cls = "MiscService_getZen_closure";
  if (!"name" in MiscService_getZen_closure)
    MiscService_getZen_closure.name = "MiscService_getZen_closure";
  $desc = $collectedClasses.MiscService_getZen_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MiscService_getZen_closure.prototype = $desc;
