...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    asyncStarHelper: function(object, bodyFunctionOrErrorCode, controller) {
      var error, t1, t2, stream, future;
      if (bodyFunctionOrErrorCode === 0) {
        if (controller.get$isCanceled())
          controller.cancelationCompleter.complete$0(0);
        else
          controller.controller.close$0(0);
        return;
      } else if (bodyFunctionOrErrorCode === 1) {
        if (controller.get$isCanceled())
          controller.cancelationCompleter.completeError$2(H.unwrapException(object), H.getTraceFromException(object));
        else {
          error = H.unwrapException(object);
          t1 = H.getTraceFromException(object);
          t2 = controller.controller;
          if (t2._state >= 4)
            H.throwExpression(t2._badEventState$0());
          error = error != null ? error : new P.NullThrownError();
          $.Zone__current.toString;
          t2._addError$2(error, t1);
          controller.controller.close$0(0);
        }
        return;
      }
      t1 = J.getInterceptor(object);
      if (!!t1.$isIterationMarker) {
        if (controller.get$isCanceled()) {
          H._wrapJsFunctionForAsync(bodyFunctionOrErrorCode, 2).call$1(null);
          return;
        }
        t2 = object.state;
        if (t2 === 0) {
          ...
          if (t2._state >= 4)
            H.throwExpression(t2._badEventState$0());
          t2._async$_add$1(t1);
          P.scheduleMicrotask(new H.asyncStarHelper_closure(bodyFunctionOrErrorCode, controller));
          return;
        } else if (t2 === 1) {
          stream = object.value;
          controller.controller.addStream$2$cancelOnError(stream, false).then$1(new H.asyncStarHelper_closure0(bodyFunctionOrErrorCode, controller));
          return;
        }
      }
      if (!!t1.$isFuture)
      ...
      future.then$2$onError(H._wrapJsFunctionForAsync(bodyFunctionOrErrorCode, 0), new H.asyncStarHelper_closure1(bodyFunctionOrErrorCode));
    },
    streamOfController: function(controller) {
    ...
    _wrapJsFunctionForAsync_closure: {
      "^": "Closure:1;_captured_errorCode_0,_captured_protected_1",
      call$1: function(result) {
        this._captured_protected_1(this._captured_errorCode_0, result);
      }
    },
    asyncStarHelper_closure: {
      ...
      call$0: function() {
        ...
        t2 = t1.controller;
        t3 = t2._state;
        if ((t3 & 1) !== 0 ? t2.get$_subscription().get$_isInputPaused() : (t3 & 2) === 0) {
          t1.isSuspended = true;
          return;
        }
        H._wrapJsFunctionForAsync(this._captured_bodyFunctionOrErrorCode_0, 0).call$1(null);
      }
    },
    asyncStarHelper_closure0: {
      "^": "Closure:1;_captured_bodyFunctionOrErrorCode_2,_captured_controller_3",
      call$1: function(_) {
        var errorCode = this._captured_controller_3.cancelationCompleter != null ? 2 : 0;
        H._wrapJsFunctionForAsync(this._captured_bodyFunctionOrErrorCode_2, errorCode).call$1(null);
      }
    },
    asyncStarHelper_closure1: {
      "^": "Closure:4;_captured_bodyFunctionOrErrorCode_4",
      call$2: function(error, stackTrace) {
        return H._wrapJsFunctionForAsync(this._captured_bodyFunctionOrErrorCode_4, 1).call$1(new H.ExceptionAndStackTrace(error, stackTrace));
      }
    },
    AsyncStarStreamController: {
      "^": "Object;controller,isSuspended,cancelationCompleter",
      get$stream: function(_) {
        var t1 = this.controller;
        t1.toString;
        return H.setRuntimeTypeInfo(new P._ControllerStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      },
      ...
      AsyncStarStreamController$1: function(body) {
        var t1 = new H.AsyncStarStreamController__resumeBody(body);
        this.controller = P.StreamController_StreamController(new H.AsyncStarStreamController_closure(this, body), new H.AsyncStarStreamController_closure0(t1), null, new H.AsyncStarStreamController_closure1(this, t1), false, null);
      },
      static: {AsyncStarStreamController$: function(body) {
          var t1 = new H.AsyncStarStreamController(null, false, null);
          t1.AsyncStarStreamController$1(body);
          return t1;
        }}
    },
    AsyncStarStreamController__resumeBody: {
      "^": "Closure:0;_captured_body_0",
      call$0: function() {
        P.scheduleMicrotask(new H.AsyncStarStreamController__resumeBody_closure(this._captured_body_0));
      }
    },
    AsyncStarStreamController__resumeBody_closure: {
      "^": "Closure:0;_captured_body_1",
      call$0: function() {
        H._wrapJsFunctionForAsync(this._captured_body_1, 0).call$1(null);
      }
    },
    AsyncStarStreamController_closure0: {
      "^": "Closure:0;_captured__resumeBody_2",
      call$0: function() {
        this._captured__resumeBody_2.call$0();
      }
    },
    AsyncStarStreamController_closure1: {
    ...
    AsyncStarStreamController_closure: {
      ...
      call$0: function() {
        ...
        if ((t1.controller._state & 4) === 0) {
          ...
          if (t1.isSuspended) {
            t1.isSuspended = false;
            P.scheduleMicrotask(new H.AsyncStarStreamController__closure(this._captured_body_6));
          }
          return t1.cancelationCompleter.future;
        }
      }
    },
    AsyncStarStreamController__closure: {
      "^": "Closure:0;_captured_body_7",
      call$0: function() {
        H._wrapJsFunctionForAsync(this._captured_body_7, 2).call$1(null);
      }
    },
    IterationMarker: {
      "^": "Object;value,state",
      ...
      static: {IterationMarker_yieldStar: function(values) {
          return new H.IterationMarker(values, 1);
        }, IterationMarker_yieldSingle: function(value) {
          return new H.IterationMarker(value, 0);
        }}
    },
    JsLinkedHashMap: {
    ...
    init__sendCode: {
      "^": "Closure:2;_common0$_box_0,_captured_popup_4",
      call$0: function() {
        J.postMessage$2$x(this._captured_popup_4, P.LinkedHashMap__makeLiteral(["command", "code", "code", this._common0$_box_0._captured_code_0]), window.location.href);
      }
    },
    init__closure: {
      "^": "Closure:1;_common0$_box_0,_captured_sendCode_5",
      call$1: function($event) {
        var t1;
        if (J.$eq$(J.$index$asx(J.get$data$x($event), "command"), "ready")) {
          t1 = this._common0$_box_0;
    ...
    init__closure0: {
      "^": "Closure:1;_common0$_box_0,_captured_sendCode_6",
      call$1: function(c) {
        var t1 = this._common0$_box_0;
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 14, 0],
    ...
    _Future__propagateToListeners_handleValueCallback: {
      "^": "Closure:27;_box_1,_captured_listener_3,_captured_sourceValue_4,_captured_zone_5",
      call$0: function() {
        var e, s, exception, t1;
        try {
    ...
    Stream_contains__closure0: {
      "^": "Closure:28;_async$_box_0,_captured_future_6",
    ...
    Stream_toList_closure: {
      "^": "Closure;_captured_this_0,_captured_result_1",
    ...
    _JsonMap_values_closure: {
      "^": "Closure:1;_convert$_captured_this_0",
      call$1: function(each) {
    ...
    DateTime_parse_parseMilliseconds: {
      ...
      call$1: function(matched) {
        ...
        if (J.$le$n($length, 3)) {
          ...
          i = 1;
          for (; i < $length;) {
            result = result * 10 + (C.JSString_methods.codeUnitAt$1(matched, i) ^ 48);
            ++i;
          }
          for (; i < 3;) {
            result *= 10;
        ...
        result = (result * 10 + (C.JSString_methods.codeUnitAt$1(matched, 1) ^ 48)) * 10 + (C.JSString_methods.codeUnitAt$1(matched, 2) ^ 48);
        return C.JSString_methods.codeUnitAt$1(matched, 3) >= 53 ? result + 1 : result;
      }
    },
    $double: {
      "^": "num;"
    ...
    Event: {
      "^": "Interceptor;",
      "%": "AnimationPlayerEvent|ApplicationCacheErrorEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|ExtendableEvent|FontFaceSetLoadEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaQueryListEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|RTCPeerConnectionIceEvent|RelatedEvent|ResourceProgressEvent|SecurityPolicyViolationEvent|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;ClipboardEvent|Event|InputEvent"
    },
    EventTarget: {
      "^": "Interceptor;",
    ...
    _BrowserHttpClient_request_closure: {
      "^": "Closure:1;_captured_req_0,_captured_completer_1",
      call$1: function($event) {
        var t1 = this._captured_req_0;
        this._captured_completer_1.complete$1(0, new T.Response(t1.responseText, C.HttpRequest_methods.get$responseHeaders(t1), t1.status));
      }
    },
    initGitHub_closure: {
      "^": "Closure:0;",
    ...
    parseLinkHeader: function(input) {
      var out, parts, t1, _i, part, t2, kv, url;
      out = P.LinkedHashMap__makeEmpty();
      parts = J.split$1$s(input, ", ");
      for (t1 = parts.length, _i = 0; _i < parts.length; parts.length === t1 || (0, H.throwConcurrentModificationError)(parts), ++_i) {
        part = parts[_i];
        t2 = J.getInterceptor$asx(part);
        if (!J.$eq$(t2.$index(part, 0), "<"))
          throw H.wrapException(new P.FormatException("Invalid Link Header", null, null));
        kv = t2.split$1(part, "; ");
        if (0 >= kv.length)
          return H.ioore(kv, 0);
    ...
    GitHub: {
      ...
      request$6$body$headers$params$statusCode: function($receiver, method, path, body, headers, params, statusCode) {
        return this.request$8$body$fail$headers$params$preview$statusCode($receiver, method, path, body, null, headers, params, null, statusCode);
      },
    ...
    GitHub_request_closure: {
      "^": "Closure:0;_common$_captured_this_0",
      call$0: function() {
    ...
    GitHub_request_closure1: {
      "^": "Closure:1;_common$_captured_this_2,_captured_statusCode_3,_captured_fail_4",
      call$1: function(response) {
        var t1, t2, t3;
        t1 = this._common$_captured_this_2;
        t2 = J.getInterceptor$x(response);
        t3 = t2.get$headers(response);
        if (t3.containsKey$1("x-ratelimit-limit")) {
          t1._rateLimitLimit = H.Primitives_parseInt(t3.$index(0, "x-ratelimit-limit"), null, null);
          t1._rateLimitRemaining = H.Primitives_parseInt(t3.$index(0, "x-ratelimit-remaining"), null, null);
          t1._rateLimitReset = H.Primitives_parseInt(t3.$index(0, "x-ratelimit-reset"), null, null);
        }
        if (this._captured_statusCode_3 !== t2.get$statusCode(response)) {
          t2 = this._captured_fail_4;
          if (t2 != null)
            t2.call$1(response);
    ...
    Organization: {
      ...
      static: {Organization_fromJSON: [function(input) {
          ...
          return t1;
        }, "call$1", "common_Organization_fromJSON$closure", 2, 0, 35]}
    },
    Team: {
      ...
      static: {Team_fromJSON: [function(input) {
          ...
          return t1;
        }, "call$1", "common_Team_fromJSON$closure", 2, 0, 36]}
    },
    TeamMember: {
      ...
      static: {TeamMember_fromJSON: [function(input) {
          ...
          return member;
        }, "call$1", "common_TeamMember_fromJSON$closure", 2, 0, 24]}
    },
    OrganizationsService: {
      "^": "Service;_github",
      $get$1: function($name) {
        return this._github.getJSON$4$convert$fail$statusCode("/orgs/" + H.S($name), T.common_Organization_fromJSON$closure(), new T.OrganizationsService_get_closure(this, $name), 200);
      }
    },
    OrganizationsService_get_closure: {
      "^": "Closure:26;_common$_captured_this_0,_captured_name_1",
      call$1: function(response) {
        if (J.get$statusCode$x(response) === 404)
          throw H.wrapException(new T.OrganizationNotFound("Organization Not Found: " + H.S(this._captured_name_1), null, this._common$_captured_this_0._github, null));
      }
    },
    Authentication: {
    ...
    PaginationHelper: {
      "^": "Object;github",
      fetchStreamed$7$body$headers$pages$params$statusCode: function(method, path, body, headers, pages, params, statusCode) {
        var $async$goto = 0, $async$controller = H.AsyncStarStreamController$($async$fetchStreamed$7$body$headers$pages$params$statusCode), $async$nextWhenCanceled, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, t1, count, response, link, info, next, nextUrl, t2, $async$temp1, $async$temp2, $async$temp3, $async$temp4;
        function $async$fetchStreamed$7$body$headers$pages$params$statusCode($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$temp1 = P;
                params = $async$temp1.LinkedHashMap__makeEmpty();
                $async$temp1 = $async$self;
                t1 = $async$temp1.github;
                count = 0;
              case 3:
                // do body
                $async$temp1 = t1;
                $async$goto = 6;
                return H.asyncStarHelper($async$temp1.request$6$body$headers$params$statusCode(0, method, path, body, headers, params, statusCode), $async$fetchStreamed$7$body$headers$pages$params$statusCode, $async$controller);
              case 6:
                // returning from await.
                response = $async$result;
                $async$goto = 7;
                $async$nextWhenCanceled = [1];
                return H.asyncStarHelper(H.IterationMarker_yieldSingle(response), $async$fetchStreamed$7$body$headers$pages$params$statusCode, $async$controller);
              case 7:
                // after yield
                ++count;
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                link = $async$temp1.$index$asx($async$temp2.get$headers$x(response), "link");
                if (link == null) {
                  // goto after do
                  $async$goto = 5;
                  break;
                  ...
                  ;
                $async$temp1 = T;
                info = $async$temp1.parseLinkHeader(link);
                $async$temp1 = info;
                next = $async$temp1.$index(0, "next");
                if (next == null) {
                  // goto after do
                  $async$goto = 5;
                  break;
                  ...
                  ;
                $async$temp1 = P;
                nextUrl = $async$temp1.Uri_parse(next, 0, null);
                $async$temp1 = nextUrl;
                t2 = $async$temp1._queryParameters;
                $async$goto = t2 == null ? 8 : 9;
                break;
              case 8:
                // then
                $async$temp1 = nextUrl;
                t2 = $async$temp1._query;
                $async$temp1 = P;
                $async$temp1 = $async$temp1;
                $async$temp2 = P;
                $async$temp2 = $async$temp2;
                $async$temp3 = t2 == null ? "" : t2;
                $async$temp4 = C;
                t2 = new $async$temp1.UnmodifiableMapView($async$temp2.Uri_splitQueryString($async$temp3, $async$temp4.Utf8Codec_false));
                t2.$builtinTypeInfo = [null, null];
                $async$temp1 = nextUrl;
                $async$temp1._queryParameters = t2;
              case 9:
                // join
                $async$temp1 = params;
                $async$temp1 = $async$temp1;
                ...
                $async$temp2 = $async$temp2;
                $async$temp3 = t2;
                $async$temp1.$indexSet(0, "page", $async$temp2.$index$asx($async$temp3._map, "page"));
              case 4:
                // do condition
                if (true) {
                  // goto do body
              ...
              case 1:
                // return
                return H.asyncStarHelper(null, 0, $async$controller);
              case 2:
                // rethrow
                return H.asyncStarHelper($async$currentError, 1, $async$controller);
            }
        }
        return H.streamOfController($async$controller);
      },
      objects$9$body$headers$pages$params$preview$statusCode: function(method, path, converter, body, headers, pages, params, preview, statusCode) {
        var $async$goto = 0, $async$controller = H.AsyncStarStreamController$($async$objects$9$body$headers$pages$params$preview$statusCode), $async$nextWhenCanceled, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, response, json, item, t1, t2, t3, t4, $async$temp1, $async$temp2, $async$temp3, $async$temp4;
        function $async$objects$9$body$headers$pages$params$preview$statusCode($async$errorCode, $async$result) {
          switch ($async$errorCode) {
            case 2:
              $async$next = $async$nextWhenCanceled;
              $async$goto = $async$next.pop();
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 4:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = T;
                $async$temp1.putIfAbsent$2("Accept", new $async$temp2.PaginationHelper_objects_closure());
                $async$temp1 = $async$self;
                t1 = $async$temp1.fetchStreamed$7$body$headers$pages$params$statusCode(method, path, body, headers, pages, params, statusCode);
                $async$temp1 = H;
                $async$temp1 = $async$temp1;
                $async$temp2 = P;
                t2 = $async$temp1.setRuntimeTypeInfo(new $async$temp2._StreamIteratorImpl(null, null, null, 0), [null]);
                $async$temp1 = t2;
                t3 = $async$temp1.get$_async$_onData();
                $async$temp1 = t2;
                t4 = $async$temp1.get$_onError();
                $async$temp1 = t2;
                $async$temp2 = t1;
                $async$temp2 = $async$temp2;
                $async$temp3 = t3;
                $async$temp4 = t2;
                $async$temp1._subscription = $async$temp2.listen$4$cancelOnError$onDone$onError($async$temp3, true, $async$temp4.get$_onDone(), t4);
                $async$handler = 5;
              case 8:
                // for condition
                $async$temp1 = t2;
                $async$goto = 10;
                return H.asyncStarHelper($async$temp1.moveNext$0(), $async$objects$9$body$headers$pages$params$preview$statusCode, $async$controller);
              case 10:
                // returning from await.
                ...
                $async$temp1 = t2;
                response = $async$temp1._async$_current;
                $async$temp1 = response;
                json = $async$temp1.asJSON$0();
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = H;
                $async$temp1 = t1 = $async$temp1.map$1$ax($async$temp2.listTypeCast(json), converter);
                $async$temp2 = H;
                $async$temp2 = $async$temp2;
                $async$temp3 = t1;
                $async$temp4 = t1;
                $async$temp1, t1 = new $async$temp2.ListIterator($async$temp3, $async$temp4.get$length(t1), 0, null);
              case 11:
                // for condition
                $async$temp1 = t1;
                ...
                $async$temp1 = t1;
                item = $async$temp1.__internal$_current;
                $async$goto = 13;
                $async$nextWhenCanceled = [1, 6];
                return H.asyncStarHelper(H.IterationMarker_yieldSingle(item), $async$objects$9$body$headers$pages$params$preview$statusCode, $async$controller);
              case 13:
                // after yield
                // goto for condition
                $async$goto = 11;
              ...
              case 6:
                ...
                $async$temp1 = t2;
                $async$goto = 14;
                return H.asyncStarHelper($async$temp1.cancel$0(), $async$objects$9$body$headers$pages$params$preview$statusCode, $async$controller);
              case 14:
                // returning from await.
      ...
      objects$3: function(method, path, converter) {
        return this.objects$9$body$headers$pages$params$preview$statusCode(method, path, converter, null, null, null, null, null, 200);
      }
    },
    ...
    _convertDartToNative_PrepareForStructuredClone_findSlot: {
      "^": "Closure:10;_captured_values_1,_captured_copies_2",
      call$1: function(value) {
        var t1, $length, i;
    ...
    convertNativeToDart_AcceptStructuredClone_findSlot: {
      "^": "Closure:10;_captured_values_0,_captured_copies_1",
      call$1: function(value) {
        var t1, $length, i, t2;
    ...
    }, "call$0", "organization__main$closure", 0, 0, 2],
    loadOrganization: function() {
      var org, t1, onError, result, t2;
      org = J.$index$asx($.$get$queryString()._map, "name") != null ? J.$index$asx($.$get$queryString()._map, "name") : "DirectMyFile";
      t1 = $.$get$github().get$organizations().$get$1(org).then$1(new S.loadOrganization_closure()).then$1(new S.loadOrganization_closure0());
    ...
    loadOrganization_closure: {
      ...
      call$1: function(org) {
        var t1, t2;
        t1 = $.$get$github().get$organizations();
        t2 = J.get$name$x(org);
        return J.toList$0$ax(new T.PaginationHelper(t1._github).objects$3("GET", "/orgs/" + H.S(t2) + "/teams", T.common_Team_fromJSON$closure()));
      }
    },
      ...
      call$1: function(teams) {
        ...
        for (t1 = J.get$iterator$ax(teams); t1.moveNext$0();) {
          ...
          if (t4 == null) {
            ...
            t3 = t4;
          t2 = t2.get$id(team);
          J.toList$0$ax(new T.PaginationHelper(t3._github).objects$3("GET", "/teams/" + H.S(t2) + "/members", T.common_TeamMember_fromJSON$closure())).then$1(new S.loadOrganization__closure(e));
        }
      }
    },
    loadOrganization__closure: {
      "^": "Closure:32;_captured_e_0",
      call$1: function(members) {
        J.map$1$ax(members, new S.loadOrganization___closure()).forEach$1(0, J.get$append$x(this._captured_e_0));
      }
    },
    ...
    loadOrganization_closure1: {
      "^": "Closure:1;",
      call$1: function(error) {
        if (error instanceof T.OrganizationNotFound)
...
;
  ...
  (function(lazies) {
    ...
    return P.Uri_parse(C.Window_methods.get$location(W.window()).href, 0, null).get$queryParameters();
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, void: true}, {func: 1, args: [,,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.$int,,]}, {func: 1, void: true, args: [P.Object, P.StackTrace]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, void: true, args: [P.$int, P.$int]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, void: true, args: [P.String]}, {func: 1, void: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, ret: T.TeamMember, args: [,]}, {func: 1, ret: W.Node, args: [W.Node]}, {func: 1, args: [T.Response]}, {func: 1, ret: P.bool}, {func: 1, args: [P.bool]}, {func: 1, args: [P.String]}, {func: 1, args: [T.Organization]}, {func: 1, args: [[P.List, T.Team]]}, {func: 1, args: [[P.List, T.TeamMember]]}, {func: 1, ret: P.num}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, ret: T.Organization, args: [,]}, {func: 1, ret: T.Team, args: [,]}, {func: 1, args: [W.HttpRequest]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(S.organization__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(S.organization__main$closure(), a);
