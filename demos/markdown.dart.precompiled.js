...
["github.browser", "package:github/browser.dart", , M, {
  ...
  GitHubBrowserHelper_renderMarkdown: function(github, selector, indent) {
    var elements, t1, e, t2, md;
    elements = W._FrozenElementList$_wrap(document.querySelectorAll(selector), null);
    elements.removeWhere$1(elements, new M.GitHubBrowserHelper_renderMarkdown_closure());
    for (t1 = elements.get$iterator(elements); t1.moveNext$0();) {
      e = t1.__internal$_current;
      t2 = new H.MappedListIterable(J.get$text$x(e).split("\n"), new M.GitHubBrowserHelper_renderMarkdown_closure0(indent));
      t2.$builtinTypeInfo = [null, null];
      md = t2.join$1(0, "\n");
      t2 = github._misc;
      if (t2 == null) {
        t2 = new T.MiscService(github);
        github._misc = t2;
      }
      t2.renderMarkdown$1(md).then$1(new M.GitHubBrowserHelper_renderMarkdown_closure1(e));
    }
  },
  _BrowserHttpClient: {
    "^": "Client;",
    request$1: function(_, request) {
      var req, t1, completer, t2, t3, header;
      req = new XMLHttpRequest();
      t1 = T.Response;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [t1])), [t1]);
      C.HttpRequest_methods.open$2(req, request.method, request.url);
      for (t1 = request.headers, t2 = t1.get$keys()._map, t3 = new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), t3._cell = t2._first; t3.moveNext$0();) {
        header = t3._collection$_current;
  ...
  GitHubBrowserHelper_renderMarkdown_closure: {
    "^": "Closure:26;",
    call$1: function(it) {
      return J.get$attributes$x(it)._element.hasAttribute("rendered");
    },
    $isFunction: true
  },
  GitHubBrowserHelper_renderMarkdown_closure0: {
    "^": "Closure:12;indent_0",
    call$1: function(it) {
      var t1, t2;
      t1 = J.getInterceptor$asx(it);
      t2 = this.indent_0;
      return J.$ge$n(t1.get$length(it), t2) ? t1.substring$1(it, t2) : it;
    },
    $isFunction: true
  },
  GitHubBrowserHelper_renderMarkdown_closure1: {
    "^": "Closure:12;e_1",
    call$1: function(html) {
      ...
      t1.setAttribute("rendered", "");
      t2.get$classes(t1).add$1(0, "markdown-body");
      t2.set$innerHtml(t1, html);
    },
    $isFunction: true
  }
}],
...
["", "markdown.dart", , T, {
  "^": "",
  main: [function() {
    R.init("markdown.dart", new T.main_closure());
  ...
  main_closure: {
    ...
    call$0: function() {
      ...
      M.GitHubBrowserHelper_renderMarkdown(new T.GitHub(t1, "https://api.github.com", t2, null, null, null, null, null, null, null, null, null, null, null, null, null, null), "*[markdown]", 4);
    },
    $isFunction: true
  }
},
...
function dart_precompiled($collectedClasses) {
  ...
  function GitHubBrowserHelper_renderMarkdown_closure() {
  }
  GitHubBrowserHelper_renderMarkdown_closure.builtin$cls = "GitHubBrowserHelper_renderMarkdown_closure";
  if (!"name" in GitHubBrowserHelper_renderMarkdown_closure)
    GitHubBrowserHelper_renderMarkdown_closure.name = "GitHubBrowserHelper_renderMarkdown_closure";
  $desc = $collectedClasses.GitHubBrowserHelper_renderMarkdown_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GitHubBrowserHelper_renderMarkdown_closure.prototype = $desc;
  function GitHubBrowserHelper_renderMarkdown_closure0(indent_0) {
    this.indent_0 = indent_0;
  }
  GitHubBrowserHelper_renderMarkdown_closure0.builtin$cls = "GitHubBrowserHelper_renderMarkdown_closure0";
  if (!"name" in GitHubBrowserHelper_renderMarkdown_closure0)
    GitHubBrowserHelper_renderMarkdown_closure0.name = "GitHubBrowserHelper_renderMarkdown_closure0";
  $desc = $collectedClasses.GitHubBrowserHelper_renderMarkdown_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GitHubBrowserHelper_renderMarkdown_closure0.prototype = $desc;
  function GitHubBrowserHelper_renderMarkdown_closure1(e_1) {
    this.e_1 = e_1;
  }
  GitHubBrowserHelper_renderMarkdown_closure1.builtin$cls = "GitHubBrowserHelper_renderMarkdown_closure1";
  if (!"name" in GitHubBrowserHelper_renderMarkdown_closure1)
    GitHubBrowserHelper_renderMarkdown_closure1.name = "GitHubBrowserHelper_renderMarkdown_closure1";
  $desc = $collectedClasses.GitHubBrowserHelper_renderMarkdown_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GitHubBrowserHelper_renderMarkdown_closure1.prototype = $desc;
