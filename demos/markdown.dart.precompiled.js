...
["github.browser", "package:github/browser.dart", , M, {
  ...
  GitHubBrowserHelper_renderMarkdown: function(github, selector, indent) {
    var elements, t1, e, t2, t3, result;
    ...
    for (t1 = elements.get$iterator(elements); t1.moveNext$0();) {
      ...
      t2 = github.renderMarkdown$1(t2.join$1(0, "\n"));
      t3 = $.Zone__current;
      t3.toString;
      result = new P._Future(0, t3, null, null, new M.GitHubBrowserHelper_renderMarkdown_closure1(e), null, P._registerErrorHandler(null, t3), null);
...
["", "markdown.dart", , T, {
  ...
  main_closure: {
    ...
    call$0: function() {
      ...
      M.GitHubBrowserHelper_renderMarkdown(new T.GitHub(t1, "https://api.github.com", t2, null), "*[markdown]", 4);
    },
    $isFunction: true
  }
},
