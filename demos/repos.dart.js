...
["", "repos.dart", , D, {
  ...
  loadRepos: function(compare) {
    ...
    if ($.get$queryString()._collection$_map.containsKey$1("sort") === true && t1.compare_0 == null) {
...
{func: "", args: [P.$int]},
{func: "", args: [P.$int,,]},
{func: "", args: [T.Repository, T.Repository]},
{func: "", ret: P.num},
...
{func: "", ret: T.Repository, args: [,], opt: [T.Repository]},
];
$ = null;
