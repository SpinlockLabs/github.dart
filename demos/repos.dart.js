...
["_js_helper", "dart:_js_helper", , H, {
  ...
  Primitives_dateNow: [function() {
    return Date.now();
  }, "call$0", "Primitives_dateNow$closure", 0, 0, 32],
...
["", "common.dart", , R, {
  ...
  init__sendCode: {
    "^": "Closure:1;_common$_box_0,_captured_popup_4",
    call$0: function() {
      J.postMessage$2$x(this._captured_popup_4, P.LinkedHashMap_LinkedHashMap$_literal(["command", "code", "code", this._common$_box_0._captured_code_0], null, null), window.location.href);
    }
  },
  init__closure: {
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$1", "_AsyncRun__scheduleImmediateJsOverride$closure", 2, 0, 33],
  _AsyncRun__scheduleImmediateWithSetImmediate: [function(callback) {
    ++init.globalState.topEventLoop._activeJsAsyncCount;
    self.setImmediate(H.convertDartClosureToJS(new P._AsyncRun__scheduleImmediateWithSetImmediate_internalCallback(callback), 0));
  }, "call$1", "_AsyncRun__scheduleImmediateWithSetImmediate$closure", 2, 0, 33],
  _AsyncRun__scheduleImmediateWithTimer: [function(callback) {
    P.Timer__createTimer(C.Duration_0, callback);
  }, "call$1", "_AsyncRun__scheduleImmediateWithTimer$closure", 2, 0, 33],
  ...
  }, "call$1", "_nullDataHandler$closure", 2, 0, 34],
...
["dart.collection", "dart:collection", , P, {
  ...
  _defaultEquals: [function(a, b) {
    return J.$eq(a, b);
  }, "call$2", "_defaultEquals$closure", 4, 0, 35],
...
["dart.core", "dart:core", , P, {
  ...
  Uri__makeQuery_closure: {
    "^": "Closure:12;_box_0,_core$_captured_result_1",
    call$2: function(key, value) {
      var t1 = this._box_0;
      if (!t1._captured_first_0)
  ...
  Uri_splitQueryString_closure: {
    "^": "Closure:12;_captured_encoding_0",
...
["dart.dom.html", "dart:html", , W, {
  ...
  HtmlElement: {
    ...
    $isNode: 1,
    $isObject: 1,
    "%": "HTMLAppletElement|HTMLBRElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLImageElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMenuItemElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLOptGroupElement|HTMLOptionElement|HTMLParagraphElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|PluginPlaceholderElement;HTMLElement"
  },
  AnchorElement: {
  ...
  Element: {
    ...
    insertAdjacentHtml$2: function(receiver, where, html) {
      ...
      if (!!receiver.insertAdjacentHTML)
        ...
        t1 = document.body;
        t1 = (t1 && C.BodyElement_methods).createFragment$3$treeSanitizer$validator(t1, html, null, null);
    ...
    get$_hasCorruptedAttributes: function(receiver) {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AnimationPlayerEvent|ApplicationCacheErrorEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|ExtendableEvent|FontFaceSetLoadEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaQueryListEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|RTCPeerConnectionIceEvent|RelatedEvent|ResourceProgressEvent|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
  ...
  _Html5NodeValidator: {
    ...
    static: {_Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 39], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 39]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
  ...
  _ValidatingTreeSanitizer: {
    ...
    sanitizeNode$2: function(node, $parent) {
      var t1, attrs, isAttr, t2, keys, i, $name;
      switch (node.nodeType) {
        case 1:
          t1 = J.getInterceptor$x(node);
          if (t1.get$_hasCorruptedAttributes(node)) {
            window;
            t1 = "Removing element due to corrupted attributes on <" + t1.toString$0(node) + ">";
            if (typeof console != "undefined")
              console.warn(t1);
            this._removeNode$2(node, $parent);
            break;
          }
          attrs = new W._ElementAttributeMap(node);
          ...
          t2 = attrs.get$keys();
          keys = H.setRuntimeTypeInfo(t2.slice(), [H.getTypeArgumentByIndex(t2, 0)]);
          for (i = attrs.get$keys().length - 1; i >= 0; --i) {
            if (i >= keys.length)
              return H.ioore(keys, i);
            $name = keys[i];
            if (!this.validator.allowsAttribute$3(node, J.toLowerCase$0$s($name), node.getAttribute($name))) {
              window;
              t2 = "Removing disallowed attribute <" + H.S(node.tagName) + " " + $name + "=\"" + H.S(node.getAttribute($name)) + "\">";
              if (typeof console != "undefined")
                console.warn(t2);
...
["github.common", "package:github/common.dart", , T, {
  ...
  parseLinkHeader: function(input) {
    ...
    for (t1 = new J.ArrayIterator(parts, parts.length, 0, null); t1.moveNext$0();) {
  ...
  GitHub: {
        ...
        case 422:
          ...
          if (errors != null) {
            ...
            for (t1 = J.get$iterator$ax(errors); t1.moveNext$0();) {
              ...
              t2 = buff._contents += "    Resource: " + H.S(resource);
              buff._contents = t2 + "\n";
              t2 = buff._contents += "    Field " + H.S(field);
              buff._contents = t2 + "\n";
    ...
    request$6$body$headers$params$statusCode: function($receiver, method, path, body, headers, params, statusCode) {
      return this.request$7$body$fail$headers$params$statusCode($receiver, method, path, body, null, headers, params, statusCode);
    }
  },
  ...
  GitHub_request_closure0: {
    "^": "Closure:0;_captured_userAndPass_1",
    call$0: function() {
      return "basic " + this._captured_userAndPass_1;
    }
  },
  ...
  GitHub_request_closure2: {
    "^": "Closure:2;_common0$_captured_this_2,_captured_statusCode_3,_captured_fail_4",
    call$1: function(response) {
      if (this._captured_statusCode_3 !== J.get$statusCode$x(response))
        this._common0$_captured_this_2.handleStatusCode$1(response);
      else
        return response;
    }
  },
  Repository: {
    ...
    static: {Repository_fromJSON: [function(input, instance) {
      ...
      }, null, "call$2", "call$1", "Repository_fromJSON$closure", 2, 2, 40, 0]}
  },
  CloneUrls: {
  ...
  PaginationHelper: {
    "^": "Object;github",
    fetchStreamed$9$body$headers$pages$params$reverse$start$statusCode: function(method, path, body, headers, pages, params, reverse, start, statusCode) {
      var t1, controller, t2, onError, result;
      t1 = {};
      t1._captured_headers_0 = headers;
      ...
      t2 = new T.PaginationHelper_fetchStreamed_actualFetch(t1, this, method, start, params, body, statusCode);
      t1._captured_count_1 = 0;
      t2 = t2.call$2(path, true).then$1(new T.PaginationHelper_fetchStreamed_closure(t1, reverse, controller, t2, new T.PaginationHelper_fetchStreamed_handleResponse(t1, pages, reverse, controller, t2)));
      onError = new T.PaginationHelper_fetchStreamed_closure0(controller);
      result = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
      t1 = result._zone;
      if (t1 !== C.C__RootZone)
        onError = P._registerErrorHandler(onError, t1);
    ...
    objects$10$body$headers$pages$params$reverse$start$statusCode: function(method, path, converter, body, headers, pages, params, reverse, start, statusCode) {
      var t1;
      headers = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      headers.putIfAbsent$2("Accept", new T.PaginationHelper_objects_closure());
      t1 = this.fetchStreamed$9$body$headers$pages$params$reverse$start$statusCode(method, path, body, headers, pages, params, reverse, start, statusCode);
      return H.setRuntimeTypeInfo(new P._ExpandStream(new T.PaginationHelper_objects_closure0(converter), t1), [H.getRuntimeTypeArgument(t1, "Stream", 0), null]);
    },
    objects$4$params: function(method, path, converter, params) {
      return this.objects$10$body$headers$pages$params$reverse$start$statusCode(method, path, converter, null, null, null, params, false, null, 200);
    }
  },
  PaginationHelper_fetchStreamed_actualFetch: {
    "^": "Closure:26;_common0$_box_0,_captured_this_1,_captured_method_2,_captured_start_3,_captured_params_4,_captured_body_5,_captured_statusCode_6",
    call$2: function(realPath, first) {
      var p = this._captured_params_4;
      if (first)
        ;
      if (!first)
        p = null;
      return this._captured_this_1.github.request$6$body$headers$params$statusCode(0, this._captured_method_2, realPath, this._captured_body_5, this._common0$_box_0._captured_headers_0, p, this._captured_statusCode_6);
    },
    call$1: function(realPath) {
      return this.call$2(realPath, false);
    }
  },
  PaginationHelper_fetchStreamed_handleResponse: {
    "^": "Closure:27;_common0$_box_0,_captured_pages_7,_captured_reverse_8,_captured_controller_9,_captured_actualFetch_10",
    call$1: function(response) {
      var t1, t2, info, nextUrl;
      ++this._common0$_box_0._captured_count_1;
      t1 = this._captured_controller_9;
      if (!t1.get$_mayAddEvent())
        H.throwExpression(t1._addEventError$0());
      t1._sendData$1(response);
      t2 = J.getInterceptor$x(response);
      if (!t2.get$headers(response).containsKey$1("link")) {
        t1.close$0(0);
        return;
      }
      info = T.parseLinkHeader(J.$index$asx(t2.get$headers(response), "link"));
      t2 = this._captured_reverse_8;
      if (!info.containsKey$1(t2 ? "prev" : "next")) {
        t1.close$0(0);
        return;
      }
      nextUrl = t2 ? info.$index(0, "prev") : info.$index(0, "next");
      this._captured_actualFetch_10.call$1(nextUrl).then$1(this);
    }
  },
  PaginationHelper_fetchStreamed_closure: {
    "^": "Closure:2;_common0$_box_0,_captured_reverse_11,_captured_controller_12,_captured_actualFetch_13,_captured_handleResponse_14",
    call$1: function(response) {
      var info;
      if (this._common0$_box_0._captured_count_1 === 0 && this._captured_reverse_11) {
        info = T.parseLinkHeader(J.$index$asx(J.get$headers$x(response), "link"));
        if (!info.containsKey$1("last")) {
          this._captured_controller_12.close$0(0);
          return;
        }
        this._captured_actualFetch_13.call$2(info.$index(0, "last"), true);
      } else
        this._captured_handleResponse_14.call$1(response);
    }
  },
  PaginationHelper_fetchStreamed_closure0: {
    "^": "Closure:12;_captured_controller_15",
    call$2: function(e, s) {
      var t1, error;
      t1 = this._captured_controller_15;
      error = e != null ? e : new P.NullThrownError();
      if (!t1.get$_mayAddEvent())
        H.throwExpression(t1._addEventError$0());
      $.Zone__current.toString;
      t1._sendError$2(error, s);
      t1.close$0(0);
    }
  },
  ...
  PaginationHelper_objects_closure0: {
    "^": "Closure:2;_captured_converter_0",
    call$1: function(response) {
      return J.map$1$ax(H.listTypeCast(response.asJSON$0()), this._captured_converter_0).toList$1$growable(0, false);
    }
  },
  Service: {
    "^": "Object;"
...
["html_common", "dart:html_common", , P, {
  ...
  _convertDartToNative_PrepareForStructuredClone_findSlot: {
    "^": "Closure:28;_captured_values_1,_captured_copies_2",
    call$1: function(value) {
      var t1, $length, i;
  ...
  _convertDartToNative_PrepareForStructuredClone_walk_closure: {
    "^": "Closure:12;_html_common$_box_0,_captured_walk_8",
    call$2: function(key, value) {
      this._html_common$_box_0._captured_copy_0[key] = this._captured_walk_8.call$1(value);
    }
  },
  convertNativeToDart_AcceptStructuredClone_findSlot: {
    "^": "Closure:28;_captured_values_0,_captured_copies_1",
    call$1: function(value) {
      var t1, $length, i, t2;
...
["", "repos.dart", , D, {
  ...
  loadRepos: function(compare) {
    ...
    if ($.get$queryString()._collection$_map.containsKey$1("sort") === true && t1._captured_compare_0 == null) {
      sorter = J.$index$asx($.get$queryString()._collection$_map, "sort");
      if ($.get$sorts().containsKey$1(sorter))
        t1._captured_compare_0 = $.get$sorts().$index(0, sorter);
    }
    if (t1._captured_compare_0 == null)
  ...
  main_closure: {
    "^": "Closure:2;_captured_stopwatch_0",
    call$1: function($event) {
      var t1;
      if (document.readyState === "complete") {
...
(function(lazies) {
...
}, "undefinedLiteralPropertyPattern", "queryString", "get$queryString", function() {
  var t1, t2;
  ...
  if (t2 == null) {
    ...
    t1 = t2;
  return t1;
}, "queryString", "github", "get$github", function() {
  M.initGitHub();
  var t1 = $.get$queryString().$index(0, "token") != null ? new T.Authentication($.get$queryString().$index(0, "token"), null, null, false, false, true) : T.Authentication$anonymous();
  return new T.GitHub(t1, "https://api.github.com", $.GitHub_defaultClient.call$0(), null, null, null, null, null, null, null, null, null, null, null, null, null, null);
}, "github", "_AsyncRun_scheduleImmediateClosure", "get$_AsyncRun_scheduleImmediateClosure", function() {
...
}, "_attributeValidators", "sorts", "get$sorts", function() {
...
{
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, void: true, args: [P.$int, P.$int]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, ret: P.$double, args: [P.String]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [P.$int]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, void: true, args: [P.String]}, {func: 1, void: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, ret: [P.Future, T.Response], args: [P.String], opt: [P.bool]}, {func: 1, args: [T.Response]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.$int,,]}, {func: 1, args: [T.Repository, T.Repository]}, {func: 1, ret: P.num}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.$int, args: [P.Object]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, ret: T.Repository, args: [,], opt: [T.Repository]}];
}
