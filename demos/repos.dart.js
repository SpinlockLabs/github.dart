...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    asyncStarHelper_closure1: {
      "^": "Closure:5;_captured_bodyFunctionOrErrorCode_4",
    ...
    initHooks_closure0: {
      "^": "Closure:27;_captured_getUnknownTag_1",
      call$2: function(o, tag) {
        return this._captured_getUnknownTag_1(o, tag);
      }
    },
    initHooks_closure1: {
      "^": "Closure:34;_captured_prototypeForTag_2",
      call$1: function(tag) {
    ...
    init__sendCode: {
      "^": "Closure:2;_common$_box_0,_captured_popup_4",
      call$0: function() {
    ...
    Stream_contains__closure0: {
      "^": "Closure:26;_async$_box_0,_captured_future_6",
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 8, 0],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 28],
    ...
    _Html5NodeValidator: {
      ...
      static: {_Html5NodeValidator$: function(uriPolicy) {
          ...
          return true;
        }, "call$4", "html__Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 7], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
          var t1, t2, t3, t4, t5;
    ...
    _ValidatingTreeSanitizer_sanitizeTree_walk: {
      "^": "Closure:25;_html$_captured_this_0",
    ...
    GitHub_request_closure: {
      "^": "Closure:0;_common0$_captured_this_0",
      call$0: function() {
        return "token " + H.S(this._common0$_captured_this_0.auth.token);
      }
    },
    ...
    GitHub_request_closure1: {
      "^": "Closure:1;_common0$_captured_this_2,_captured_statusCode_3,_captured_fail_4",
      call$1: function(response) {
        var t1, t2, t3;
        t1 = this._common0$_captured_this_2;
    ...
    Repository: {
      ...
      toString$0: function(_) {
        return "Repository: " + H.S(this.owner.login) + "/" + H.S(this.name);
      },
      static: {Repository_fromJSON: [function(input, instance) {
          ...
          t2 = J.getInterceptor$x(instance);
          t2.set$name(instance, t1.$index(input, "name"));
          t2.set$id(instance, t1.$index(input, "id"));
          instance.set$fullName(t1.$index(input, "full_name"));
        ...
        }, "call$2", "call$1", "common0_Repository_fromJSON$closure", 2, 2, 22, 0]}
    },
    CloneUrls: {
    ...
    PaginationHelper: {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$temp1 = P;
                params = $async$temp1.LinkedHashMap_LinkedHashMap$from(params, null, null);
              ...
              case 9:
                ...
                $async$temp2 = $async$temp2;
                $async$temp3 = t2;
                $async$temp1.$indexSet(0, "page", $async$temp2.$index$asx($async$temp3._collection$_map, "page"));
              case 4:
                // do condition
                if (true) {
                  // goto do body
      ...
      objects$4$params: function(method, path, converter, params) {
        return this.objects$9$body$headers$pages$params$preview$statusCode(method, path, converter, null, null, null, params, null, 200);
      }
    },
    ...
    _convertDartToNative_PrepareForStructuredClone_findSlot: {
      "^": "Closure:12;_captured_values_1,_captured_copies_2",
      call$1: function(value) {
        var t1, $length, i;
    ...
    convertNativeToDart_AcceptStructuredClone_findSlot: {
      "^": "Closure:12;_captured_values_0,_captured_copies_1",
      call$1: function(value) {
        var t1, $length, i, t2;
    ...
    }, "call$0", "repos__main$closure", 0, 0, 2],
    updateRepos: function(repos, compare) {
      ...
      for (t1 = t1.get$iterator(repos); t1.moveNext$0();) {
        ...
        J.insertAdjacentHtml$4$treeSanitizer$validator$x(t2, "beforeend", t3 + (t7 + (t8 + A.friendlySecond(t5) + " " + suffix + " (in " + H.S(t4.get$timeZoneName()) + ")")) + "\n          <br/>\n          <b>Size</b>: " + H.S(repo.size) + " bytes\n          <p></p>\n        </div>\n      ", null, null);
      }
    },
    loadRepos: function(compare) {
      var t1, title, t2, user, sorter, t3, params;
      t1 = {};
      t1._captured_compare_0 = compare;
      ...
      user = $.$get$queryString()._collection$_map.containsKey$1("user") === true ? J.$index$asx($.$get$queryString()._collection$_map, "user") : "DirectMyFile";
      if ($.$get$queryString()._collection$_map.containsKey$1("sort") === true && compare == null) {
        sorter = J.$index$asx($.$get$queryString()._collection$_map, "sort");
        ...
        t2 = compare;
      if (t2 == null)
        t1._captured_compare_0 = new D.loadRepos_closure();
      t2 = $.$get$github();
      t3 = t2._repositories;
      if (t3 == null) {
        ...
        t2 = t3;
      t2.toString;
      params = P.LinkedHashMap__makeLiteral(["type", "owner", "sort", "full_name", "direction", "asc"]);
      J.toList$0$ax(new T.PaginationHelper(t2._github).objects$4$params("GET", "/users/" + H.S(user) + "/repos", T.common0_Repository_fromJSON$closure(), params)).then$1(new D.loadRepos_closure0(t1));
    },
    closure: {
      "^": "Closure:4;",
      call$2: function(a, b) {
    ...
    main_closure: {
      "^": "Closure:1;_captured_stopwatch_0",
      call$1: function($event) {
        var t1;
        if (document.readyState === "complete") {
          t1 = this._captured_stopwatch_0;
          t1.stop$0(0);
    ...
    main__closure: {
      "^": "Closure:1;_captured_name_1",
      call$1: function($event) {
        if ($._reposCache == null)
          D.loadRepos($.$get$sorts().$index(0, this._captured_name_1));
        D.updateRepos($._reposCache, $.$get$sorts().$index(0, this._captured_name_1));
      }
    },
    loadRepos_closure: {
      "^": "Closure:3;",
    ...
    loadRepos_closure0: {
      "^": "Closure:1;_repos$_box_0",
      call$1: function(repos) {
        $._reposCache = repos;
        D.updateRepos(repos, this._repos$_box_0._captured_compare_0);
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  }, "sorts", "$get$sorts", "sorts", function() {
    return P.LinkedHashMap__makeLiteral(["stars", new D.closure(), "forks", new D.closure0(), "created", new D.closure1(), "pushed", new D.closure2(), "size", new D.closure3()]);
  }]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, void: true}, {func: 1, args: [,,]}, {func: 1, args: [T.Repository, T.Repository]}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.$int,,]}, {func: 1, void: true, args: [P.Object, P.StackTrace]}, {func: 1, void: true, args: [P.$int, P.$int]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, ret: P.bool}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, void: true, args: [P.String]}, {func: 1, ret: T.Repository, args: [,], opt: [T.Repository]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, args: [P.bool]}, {func: 1, args: [, P.String]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, void: true, args: [P.String], opt: [,]}, {func: 1, ret: P.num}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, args: [P.String]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(D.repos__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(D.repos__main$closure(), a);
