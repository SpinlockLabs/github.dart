...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Primitives_dateNow: [function() {
      return Date.now();
    }, "call$0", "_js_helper_Primitives_dateNow$closure", 0, 0, 27],
    ...
    init: function(script, onReady) {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.init_closure(script)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    init_closure: {
    ...
    _Utf8Decoder_convert_addSingleBytes: {
      "^": "Closure:21;_convert$_captured_this_1,_captured_codeUnits_2,_captured_startIndex_3,_captured_endIndex_4",
    ...
    }, "call$2", "core_Comparable_compare$closure", 4, 0, 28],
    ...
    HtmlElement: {
      ...
      $isNode: 1,
      $isObject: 1,
      "%": "HTMLAppletElement|HTMLBRElement|HTMLBaseElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMenuItemElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLOptGroupElement|HTMLOptionElement|HTMLParagraphElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|PluginPlaceholderElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
    ...
    Repository: {
      ...
      static: {Repository_fromJSON: [function(input, instance) {
        ...
        }, "call$2", "call$1", "common0_Repository_fromJSON$closure", 2, 2, 29, 0]}
    },
    CloneUrls: {
    ...
    main: [function() {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new D.main_closure(stopwatch)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = J.get$onClick$x(document.querySelector("#reload"));
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new D.main_closure0()), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    ...
    loadRepos: function(compare) {
      ...
      if (J.contains$1$asx(title.textContent, "(")) {
        t2 = C.HtmlDocument_methods.createElement$1(document, "h2");
        t3 = J.getInterceptor$x(t2);
        t3.set$text(t2, "GitHub for Dart - Repositories");
        t3.set$id(t2, "title");
      ...
      J.map$1$ax(new T.PaginationHelper(t2._github).jsonObjects$8$body$headers$pages$params$preview$statusCode("GET", "/users/" + H.S(user) + "/repos", null, null, null, params, null, 200), T.common0_Repository_fromJSON$closure()).toList$0(0).then$1(new D.loadRepos_closure0(t1));
    },
    closure: {
      "^": "Closure:4;",
      call$2: function(a, b) {
    ...
    main_closure1: {
      ...
      call$1: function($name) {
        ...
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new D.main__closure($name)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      }
    },
    main__closure: {
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, args: [T.Repository, T.Repository]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [P.bool]}, {func: 1, v: true, args: [P.Object, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, v: true, args: [P.$int, P.$int]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, ret: P.num}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: T.Repository, args: [,], opt: [T.Repository]}];
