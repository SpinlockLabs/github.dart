...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|Range|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["github.common", "package:github/common.dart", , T, {
  ...
  User: {
    ...
    static: {User_fromJSON: [function(input) {
        ...
        return t2;
      }, "call$1", "User_fromJSON$closure", 2, 0, 12]}
  },
  UsersService: {
    "^": "Service;_github"
  },
...
["", "users.dart", , L, {
  ...
  loadUsers__closure: {
    ...
    call$1: function(user) {
      ...
      h.appendChild(e);
      buff = P.StringBuffer$("");
      buff.write$1("Username: <a href=\"" + H.S(this.baseUser_1.htmlUrl) + "\">" + H.S(user.login) + "</a>");
      buff.write$1("\n");
      t1 = user.createdAt;
...
function dart_precompiled($collectedClasses) {
  ...
  function User(login, id, avatarUrl, htmlUrl, siteAdmin, name, company, blog, location, email, hirable, bio, publicReposCount, publicGistsCount, followersCount, followingCount, createdAt, updatedAt) {
    this.login = login;
    this.id = id;
  ...
  function UsersService(_github) {
    this._github = _github;
  }
  UsersService.builtin$cls = "UsersService";
  if (!"name" in UsersService)
    UsersService.name = "UsersService";
  $desc = $collectedClasses.UsersService;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UsersService.prototype = $desc;
