...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["github.browser", "package:github/browser.dart", , M, {
  ...
  BrowserFetcher_get_closure: {
    "^": "Closure:12;request_0,completer_1",
...
["github.common", "package:github/common.dart", , T, {
  ...
  Fetcher: {
    ...
    fetchJSON$2: function(path, convert) {
      ...
      return this.get$1(path).then$1(new T.Fetcher_fetchJSON_closure(t1, this));
    }
  },
...
function dart_precompiled($collectedClasses) {
  ...
  function Fetcher_fetchJSON_closure(box_0, this_1) {
    this.box_0 = box_0;
    this.this_1 = this_1;
  }
  ...
  function User(github, login, id, avatar_url, url, siteAdmin, name, company, blog, location, email, hirable, bio, publicReposCount, publicGistsCount, followersCount, followingCount, createdAt, updatedAt, json) {
    this.github = github;
    this.login = login;
    this.id = id;
