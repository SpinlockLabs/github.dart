...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.async", "dart:async", , P, {
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 19, 6]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
...
["github.common", "package:github/common.dart", , T, {
  ...
  GitHub: {
    ...
    users$2$names$pages: function(names, pages) {
      return new T.PaginationHelper(this).objects$4$pages("GET", "/users", T.User_fromJSON$closure(), pages);
    },
  ...
  GitHub_users_closure0: {
    "^": "Closure:16;controller_1",
    call$1: function(_) {
      this.controller_1.close$0(0);
    },
    $isFunction: true
  },
  ...
  GitHub_getJSON_closure0: {
    "^": "Closure:16;box_0,this_1,statusCode_2,fail_3",
  ...
  PaginationHelper_fetchStreamed_actualFetch: {
    "^": "Closure:29;box_0,this_1,method_2,start_3,params_4,body_5",
  ...
  PaginationHelper_fetchStreamed_closure: {
    "^": "Closure:30;box_0,pages_6,reverse_7,controller_8,actualFetch_9",
    call$1: function(response) {
  ...
  PaginationHelper_fetchStreamed_closure0: {
    "^": "Closure:16;box_0,reverse_10,controller_11,actualFetch_12",
    call$1: function(response) {
      var t1, info;
      t1 = this.box_0;
  ...
  PaginationHelper_objects_closure0: {
    "^": "Closure:16;this_0,converter_1,controller_2",
    call$1: function(response) {
      var t1, t2, t3, t4, t5, t6;
  ...
  User: {
    ...
    static: {User_fromJSON: [function(github, input) {
        ...
        t2 = new T.User(github, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        t2.login = t1.$index(input, "login");
        t2.id = t1.$index(input, "id");
        t2.avatarUrl = t1.$index(input, "avatar_url");
        t2.url = t1.$index(input, "html_url");
        ...
        t2.createdAt = M.parseDateTime(t1.$index(input, "created_at"));
        t2.updatedAt = M.parseDateTime(t1.$index(input, "updated_at"));
        t2.json = input;
        return t2;
...
["", "users.dart", , L, {
  ...
  loadUsers: function() {
    ...
    t1 = {};
    t1.column_0 = "left";
    t2 = $.github.users$1$pages(2);
    t3 = H.setRuntimeTypeInfo(new P._TakeStream(12, t2), [null]);
    t3._TakeStream$2(t2, 12, null);
    P._ForwardingStreamSubscription$(t3, new L.loadUsers_closure(t1), null, null, false, H.getRuntimeTypeArgument(t3, "_ForwardingStream", 0), H.getRuntimeTypeArgument(t3, "_ForwardingStream", 1));
  },
  main_closure: {
    "^": "Closure:14;",
    call$0: function() {
      ...
      $.github = new T.GitHub(new T.Authentication(t1, null, null, false, false, true), "https://api.github.com", t2, null);
  ...
  loadUsers_closure: {
    ...
    call$1: function(baseUser) {
      ...
      t1.toString;
      t1.getJSON$2$convert("/users/" + H.S(t2), T.User_fromJSON$closure()).then$1(new L.loadUsers__closure(this.box_0, baseUser));
    },
    $isFunction: true
  },
  loadUsers__closure: {
    "^": "Closure:16;box_0,baseUser_1",
    call$1: function(user) {
      ...
      h.appendChild(e);
      buff = P.StringBuffer$("");
      buff.write$1("Username: <a href=\"" + H.S(this.baseUser_1.url) + "\">" + H.S(user.login) + "</a>");
      buff.write$1("\n");
      t1 = user.createdAt;
      buff.write$1("Created: " + (A.friendlyDate(t1) + " at " + A.friendlyTime(t1)));
      buff.write$1("\n");
      t1 = user.updatedAt;
      buff.write$1("Updated: " + (A.friendlyDate(t1) + " at " + A.friendlyTime(t1)));
      buff.write$1("\n");
      t1 = user.company;
      if (t1 != null && J.get$isNotEmpty$asx(t1)) {
        buff.write$1("Company: " + H.S(user.company));
        buff.write$1("\n");
      }
      buff.write$1("Followers: " + H.S(user.followersCount));
      buff.write$1("\n");
      t1 = document.createElement("p", null);
      t2 = buff._contents;
      J.insertAdjacentHtml$2$x(t1, "beforeend", J.replaceAll$2$s(t2.charCodeAt(0) == 0 ? t2 : t2, "\n", "<br/>"));
      h.appendChild(t1);
      m.appendChild(h);
      t1 = this.box_0;
...
function dart_precompiled($collectedClasses) {
  ...
  function _BroadcastSubscription(_eventState, _next, _previous, _controller, _async$_onData, _onError, _onDone, _zone, _state, _cancelFuture, _pending) {
  ...
  function GitHub_users_closure(controller_0) {
  ...
  function GitHub_users_closure0(controller_1) {
    this.controller_1 = controller_1;
  }
  GitHub_users_closure0.builtin$cls = "GitHub_users_closure0";
  if (!"name" in GitHub_users_closure0)
    GitHub_users_closure0.name = "GitHub_users_closure0";
  $desc = $collectedClasses.GitHub_users_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GitHub_users_closure0.prototype = $desc;
  ...
  function User(github, login, id, avatarUrl, url, siteAdmin, name, company, blog, location, email, hirable, bio, publicReposCount, publicGistsCount, followersCount, followingCount, createdAt, updatedAt, json) {
    this.github = github;
    this.login = login;
    this.id = id;
  ...
  User.prototype.get$avatarUrl = function() {
  ...
  function loadUsers_closure(box_0) {
    this.box_0 = box_0;
  }
  loadUsers_closure.builtin$cls = "loadUsers_closure";
  if (!"name" in loadUsers_closure)
    loadUsers_closure.name = "loadUsers_closure";
  $desc = $collectedClasses.loadUsers_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadUsers_closure.prototype = $desc;
  function loadUsers__closure(box_0, baseUser_1) {
    this.box_0 = box_0;
    this.baseUser_1 = baseUser_1;
  }
