...
["", "users.dart", , L, {
  ...
  loadUsers__closure: {
    ...
    call$1: function(user) {
      ...
      t2 = buff._contents;
      J.insertAdjacentHtml$2$x(t1, "beforeend", H.stringReplaceAllUnchecked(t2, "\n", "<br/>"));
      h.appendChild(t1);
      m.appendChild(h);
      t1 = this.box_0;
