...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|Navigator|NavigatorCPU|NavigatorUserMediaError|PositionError|Range|Request|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
  ...
  IterableMixinWorkaround: {
    ...
    static: {IterableMixinWorkaround_any: function(iterable, f) {
        ...
        for (; iterator.moveNext$0();)
          value = combine.call$2(value, iterator.__internal$_current);
        return value;
...
["dart.async", "dart:async", , P, {
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 17, 18]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 19, 18],
...
["dart.convert", "dart:convert", , P, {
  ...
  Utf8Encoder: {
    ...
    convert$1: function(string) {
      ...
      return new Uint8Array(t3.subarray(0, C.NativeUint8List_methods._checkSublistArguments$3(t3, 0, encoder._bufferIndex, t2)));
    }
  },
  _Utf8Encoder: {
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AnimationPlayerEvent|ApplicationCacheErrorEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|FontFaceSetLoadEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|RelatedEvent|ResourceProgressEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
...
["github.common", "package:github/common.dart", , T, {
  ...
  GitHub_getJSON_closure0: {
    "^": "Closure:14;box_0,this_1,statusCode_2,fail_3",
  ...
  MiscService: {
    "^": "Service;_github",
    renderMarkdown$3$context$mode: function(input, context, mode) {
      return this._github.request$3$body(0, "POST", "/markdown", C.JsonCodec_null_null.encode$1(P.LinkedHashMap_LinkedHashMap$_literal(["text", input, "mode", mode, "context", context], null, null))).then$1(new T.MiscService_renderMarkdown_closure());
    },
    renderMarkdown$1: function(input) {
      return this.renderMarkdown$3$context$mode(input, null, "markdown");
    }
  },
  MiscService_renderMarkdown_closure: {
    "^": "Closure:14;",
    call$1: function(response) {
  ...
  RepositorySlug: {
    ...
    get$hashCode: function(_) {
      return C.JSString_methods.get$hashCode(H.S(this.owner) + "/" + H.S(this.name));
    },
    toString$0: function(_) {
      return H.S(this.owner) + "/" + H.S(this.name);
    },
  ...
  RepositoriesService: {
    "^": "Service;_github",
    listLanguages$1: function(slug) {
      return this._github.getJSON$3$convert$statusCode("/repos/" + (H.S(slug.owner) + "/" + H.S(slug.name)) + "/languages", new T.RepositoriesService_listLanguages_closure(), 200);
    }
  },
  RepositoriesService_listLanguages_closure: {
    "^": "Closure:14;",
    call$1: function(input) {
...
["github.markdown", "package:github/markdown.dart", , R, {
  "^": "",
  table: function(data) {
    var buff, columns, p, t1, fm, column, t2;
    buff = P.StringBuffer$("");
    ...
    p = [];
    for (t1 = new P.LinkedHashSetIterator(columns, columns._modifications, null, null), t1._cell = columns._first, fm = true; t1.moveNext$0();) {
      ...
      t2 = " " + H.S(column) + " |";
      buff._contents += t2;
      p.push(H.S(Q.repeat("-", J.$add$ns(J.get$length$asx(column), 2))) + "|");
    }
    buff.write$1("");
    buff.write$1("\n");
    buff.write$1(C.JSArray_methods.join$0(p));
    buff.write$1("\n");
    C.JSArray_methods.forEach$1(data, new R.table_closure0(buff));
    t1 = buff._contents;
    return t1.charCodeAt(0) == 0 ? t1 : t1;
  },
  table_closure: {
    "^": "Closure:14;columns_0",
    call$1: function(row) {
      return this.columns_0.addAll$1(0, row.get$keys());
    },
    $isFunction: true
  },
  table_closure0: {
    "^": "Closure:14;buff_1",
    call$1: function(row) {
      var t1, t2, fa, value, t3;
      for (t1 = J.get$iterator$ax(J.get$values$x(row)), t2 = this.buff_1, fa = true; t1.moveNext$0();) {
...
["", "languages.dart", , M, {
  ...
  reloadTable: function(accuracy) {
    ...
    if (t2 == null) {
      ...
      t1 = t2;
    t1.renderMarkdown$1(M.generateMarkdown(accuracy)).then$1(new M.reloadTable_closure());
  },
  totalBytes: function(breakdown) {
    return J.reduce$1$ax(J.get$values$x(breakdown.get$info()), new M.totalBytes_closure());
  },
  generateMarkdown: function(accuracy) {
    var total, data, tableData;
    total = M.totalBytes($.breakdown);
    data = J.toList$0$ax($.breakdown);
    tableData = [];
    J.getInterceptor$ax(data).sort$1(data, new M.generateMarkdown_closure());
    C.JSArray_methods.forEach$1(data, new M.generateMarkdown_closure0(accuracy, total, tableData));
    return R.table(tableData);
  },
  main_closure: {
    "^": "Closure:12;",
    call$0: function() {
  ...
  generateMarkdown_closure: {
    "^": "Closure:13;",
    call$2: function(a, b) {
      return J.compareTo$1$ns(J.$index$asx(b, 1), J.$index$asx(a, 1));
    },
    $isFunction: true
  },
  generateMarkdown_closure0: {
    "^": "Closure:14;accuracy_0,total_1,tableData_2",
    call$1: function(info) {
      var t1, $name, bytes;
      t1 = J.getInterceptor$asx(info);
      $name = t1.$index(info, 0);
      bytes = t1.$index(info, 1);
      t1 = this.total_1;
      if (typeof bytes !== "number")
        return bytes.$div();
      if (typeof t1 !== "number")
        return H.iae(t1);
      this.tableData_2.push(P.LinkedHashMap_LinkedHashMap$_literal(["Name", $name, "Bytes", bytes, "Percentage", C.JSNumber_methods.toStringAsFixed$1(bytes / t1 * 100, this.accuracy_0) + "%"], null, null));
    },
    $isFunction: true
  }
},
1],
["quiver.strings", "package:quiver/strings.dart", , Q, {
  "^": "",
  flip: function(s) {
    var sb, runes, i, t1;
    if (s == null || J.$eq(s, ""))
      return s;
    sb = P.StringBuffer$("");
    runes = J.get$runes$s(s);
    for (i = runes.get$length(runes) - 1; i >= 0; --i) {
      t1 = H.Primitives_stringFromCharCode(runes.elementAt$1(0, i));
      sb._contents += t1;
    }
    t1 = sb._contents;
    return t1.charCodeAt(0) == 0 ? t1 : t1;
  ...
  repeat: function(s, times) {
    ...
    if (s == null || J.$eq(s, ""))
      return s;
    t1 = J.getInterceptor$n(times);
    if (t1.$lt(times, 0))
      return Q.repeat(Q.flip(s), t1.$negate(times));
    sink = new P.StringBuffer("");
    sink._contents = "";
    Q._repeat(sink, s, times);
    t1 = sink._contents;
    return t1.charCodeAt(0) == 0 ? t1 : t1;
  },
  _repeat: function(sink, s, times) {
    var t1, i;
...
function dart_precompiled($collectedClasses) {
  ...
  function MiscService(_github) {
    this._github = _github;
  }
  MiscService.builtin$cls = "MiscService";
  if (!"name" in MiscService)
    MiscService.name = "MiscService";
  $desc = $collectedClasses.MiscService;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MiscService.prototype = $desc;
  function MiscService_renderMarkdown_closure() {
  }
  MiscService_renderMarkdown_closure.builtin$cls = "MiscService_renderMarkdown_closure";
  if (!"name" in MiscService_renderMarkdown_closure)
    MiscService_renderMarkdown_closure.name = "MiscService_renderMarkdown_closure";
  $desc = $collectedClasses.MiscService_renderMarkdown_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  MiscService_renderMarkdown_closure.prototype = $desc;
  function RepositorySlug(owner, name) {
    this.owner = owner;
    this.name = name;
  }
  ...
  function LanguageBreakdown(_common$_data) {
    this._common$_data = _common$_data;
  }
  LanguageBreakdown.builtin$cls = "LanguageBreakdown";
  if (!"name" in LanguageBreakdown)
    LanguageBreakdown.name = "LanguageBreakdown";
  $desc = $collectedClasses.LanguageBreakdown;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LanguageBreakdown.prototype = $desc;
  function LanguageBreakdown_toString_closure(buffer_0) {
    this.buffer_0 = buffer_0;
  }
  LanguageBreakdown_toString_closure.builtin$cls = "LanguageBreakdown_toString_closure";
  if (!"name" in LanguageBreakdown_toString_closure)
    LanguageBreakdown_toString_closure.name = "LanguageBreakdown_toString_closure";
  $desc = $collectedClasses.LanguageBreakdown_toString_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  LanguageBreakdown_toString_closure.prototype = $desc;
  ...
  function RepositoriesService_listLanguages_closure() {
  }
  RepositoriesService_listLanguages_closure.builtin$cls = "RepositoriesService_listLanguages_closure";
  if (!"name" in RepositoriesService_listLanguages_closure)
    RepositoriesService_listLanguages_closure.name = "RepositoriesService_listLanguages_closure";
  $desc = $collectedClasses.RepositoriesService_listLanguages_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RepositoriesService_listLanguages_closure.prototype = $desc;
  ...
  function table_closure(columns_0) {
    this.columns_0 = columns_0;
  }
  table_closure.builtin$cls = "table_closure";
  if (!"name" in table_closure)
    table_closure.name = "table_closure";
  $desc = $collectedClasses.table_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  table_closure.prototype = $desc;
  function table_closure0(buff_1) {
    this.buff_1 = buff_1;
  }
  table_closure0.builtin$cls = "table_closure0";
  if (!"name" in table_closure0)
    table_closure0.name = "table_closure0";
  $desc = $collectedClasses.table_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  table_closure0.prototype = $desc;
