...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "Body|DOMError|DOMImplementation|FileError|MediaError|MediaKeyError|NavigatorUserMediaError|PositionError|Range|Request|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  Primitives_dateNow: [function() {
    return Date.now();
  }, "call$0", "Primitives_dateNow$closure", 0, 0, 28],
...
["dart.convert", "dart:convert", , P, {
  ...
  _JsonStringifier_writeMap_closure: {
    "^": "Closure:13;_convert$_box_0,_captured_this_1",
  ...
  _Utf8Decoder_convert_scanOneByteCharacters: {
    "^": "Closure:14;_captured_endIndex_0",
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:15;_captured_this_1,_captured_codeUnits_2,_captured_startIndex_3,_captured_endIndex_4",
...
["dart.core", "dart:core", , P, {
  ...
  Uri_parseIPv6Address_parseHex: {
    "^": "Closure:22;_captured_host_1,_captured_error_2",
...
["dart.dom.html", "dart:html", , W, {
  ...
  _Html5NodeValidator: {
    ...
    static: {_Html5NodeValidator$: function(uriPolicy) {
        ...
        return true;
      }, "call$4", "_Html5NodeValidator__standardAttributeValidator$closure", 8, 0, 36], _Html5NodeValidator__uriAttributeValidator: [function(element, attributeName, value, context) {
        var t1, t2, t3, t4, t5;
        ...
        if (!t1)
          ...
          t1 = true;
        return t1;
      }, "call$4", "_Html5NodeValidator__uriAttributeValidator$closure", 8, 0, 36]}
  },
  ImmutableListMixin: {
    "^": "Object;",
    get$iterator: function(receiver) {
  ...
  _ValidatingTreeSanitizer_sanitizeTree_walk: {
    "^": "Closure:24;_html$_captured_this_0",
...
["github.common", "package:github/common.dart", , T, {
  ...
  RepositorySlug: {
    ...
    $eq: function(_, obj) {
      if (obj == null)
        return false;
      return obj instanceof T.RepositorySlug && H.S(obj.owner) + "/" + H.S(obj.name) === H.S(this.owner) + "/" + H.S(this.name);
    },
    get$hashCode: function(_) {
  ...
  LanguageBreakdown_toString_closure: {
    "^": "Closure:12;_captured_buffer_0",
    call$2: function(key, value) {
      var t1, t2;
      t1 = this._captured_buffer_0;
      t2 = t1._contents += H.S(key) + ": " + H.S(value);
      t1._contents = t2 + "\n";
    }
  },
  RepositoriesService: {
...
["github.markdown", "package:github/markdown.dart", , R, {
  "^": "",
  table: function(data) {
    var buff, columns, p, t1, fm, column;
    buff = new P.StringBuffer("");
    ...
    for (t1 = new P.LinkedHashSetIterator(columns, columns._collection$_modifications, null, null), t1._collection$_cell = columns._collection$_first, fm = true; t1.moveNext$0();) {
      ...
      buff._contents += " " + H.S(column) + " |";
      p.push(Q.repeat("-", J.$add$ns(J.get$length$asx(column), 2)) + "|");
    }
    t1 = buff._contents;
    buff._contents = t1;
    buff._contents = t1 + "\n";
    t1 = buff._contents += C.JSArray_methods.join$0(p);
    buff._contents = t1 + "\n";
  ...
  table_closure: {
    "^": "Closure:2;_captured_columns_0",
    call$1: function(row) {
      return this._captured_columns_0.addAll$1(0, row.get$keys());
    }
  },
  table_closure0: {
    "^": "Closure:2;_captured_buff_1",
    call$1: function(row) {
      var t1, t2, fa, value;
      for (t1 = J.get$iterator$ax(J.get$values$x(row)), t2 = this._captured_buff_1, fa = true; t1.moveNext$0();) {
        value = t1.get$current();
        if (fa) {
          t2._contents += "|";
          fa = false;
        }
        t2._contents += " " + H.S(value) + " |";
      }
      t1 = t2._contents;
      t2._contents = t1;
      t2._contents = t1 + "\n";
...
["html_common", "dart:html_common", , P, {
  ...
  _convertDartToNative_PrepareForStructuredClone_findSlot: {
    "^": "Closure:25;_captured_values_1,_captured_copies_2",
    call$1: function(value) {
      var t1, $length, i;
...
["", "languages.dart", , M, {
  ...
  generateMarkdown_closure0: {
    "^": "Closure:2;_captured_accuracy_0,_captured_total_1,_captured_tableData_2",
    call$1: function(info) {
      var t1, $name, bytes;
      t1 = J.getInterceptor$asx(info);
      $name = t1.$index(info, 0);
      bytes = t1.$index(info, 1);
      t1 = this._captured_total_1;
      if (typeof bytes !== "number")
        return bytes.$div();
      if (typeof t1 !== "number")
        return H.iae(t1);
      this._captured_tableData_2.push(P.LinkedHashMap_LinkedHashMap$_literal(["Name", $name, "Bytes", bytes, "Percentage", C.JSDouble_methods.toStringAsFixed$1(bytes / t1 * 100, this._captured_accuracy_0) + "%"], null, null));
    }
  }
},
1],
["quiver.strings", "package:quiver/strings.dart", , Q, {
  ...
  flip: function(s) {
    ...
    runes = new P.Runes(s);
    for (i = runes.get$length(runes) - 1, t1 = ""; i >= 0; --i)
      t1 = sb._contents += H.Primitives_stringFromCharCode(runes.elementAt$1(0, i));
    return t1.charCodeAt(0) == 0 ? t1 : t1;
  },
...
{
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.String,,]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, void: true, args: [P.$int, P.$int]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [P.$int]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, void: true, args: [P.String]}, {func: 1, void: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.$int,,]}, {func: 1, ret: P.num}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,]}, {func: 1, ret: P.bool, args: [,,]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: P.$int, args: [P.Comparable, P.Comparable]}, {func: 1, ret: P.bool, args: [P.Object, P.Object]}, {func: 1, ret: P.$int, args: [P.Object]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}];
}
