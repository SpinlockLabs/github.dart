...
["github.common", "package:github/common.dart", , T, {
  ...
  Release: {
    "^": "Object;htmlUrl,tarballUrl<,zipballUrl,id>,tagName>,targetCommitsh,name>,body,description,draft,prerelease,createdAt,publishedAt,author,assets",
    static: {Release_fromJSON: [function(input) {
        var t1, t2;
        if (input == null)
          return;
        t1 = new T.Release(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        t1.assets = P.List_List$from(J.map$1$ax(t2.$index(input, "assets"), new T.Release_fromJSON_closure()), true, null);
        t1.name = t2.$index(input, "name");
        t1.createdAt = T.parseDateTime(t2.$index(input, "created_at"));
        t1.publishedAt = T.parseDateTime(t2.$index(input, "published_at"));
        return t1;
      }, "call$1", "Release_fromJSON$closure", 2, 0, 12]}
  },
  Release_fromJSON_closure: {
    "^": "Closure:16;",
    call$1: function(it) {
      return T.ReleaseAsset_fromJSON(it);
    },
    $isFunction: true
  },
  ReleaseAsset: {
    "^": "Object;browserDownloadUrl,id>,name>,label,state,contentType,size,downloadCount,createdAt,updatedAt",
    static: {ReleaseAsset_fromJSON: function(input) {
        var t1, t2;
        if (input == null)
          return;
        t1 = new T.ReleaseAsset(null, null, null, null, null, null, null, null, null, null);
        t2 = J.getInterceptor$asx(input);
        t1.browserDownloadUrl = t2.$index(input, "browser_download_url");
        t1.name = t2.$index(input, "name");
        t1.id = t2.$index(input, "id");
        t1.label = t2.$index(input, "label");
        t1.state = t2.$index(input, "state");
        t1.contentType = t2.$index(input, "content_type");
        t1.size = t2.$index(input, "size");
        t1.downloadCount = t2.$index(input, "download_count");
        t1.createdAt = T.parseDateTime(t2.$index(input, "created_at"));
  ...
  PaginationHelper_objects_closure0: {
    "^": "Closure:16;converter_0,controller_1",
    call$1: function(response) {
      var t1, t2, t3, t4, t5;
...
["", "releases.dart", , T, {
  ...
  loadReleases: function() {
    ...
    if (t2 == null) {
      ...
      t1 = t2;
    new T.PaginationHelper(t1._github).objects$3("GET", "/repos/twbs/bootstrap/releases", T.Release_fromJSON$closure()).toList$0(0).then$1(new T.loadReleases_closure());
  },
  main_closure: {
    "^": "Closure:14;",
    call$0: function() {
...
{func: "Release__dynamic", ret: T.Release, args: [null]},
{func: "int_", ret: P.$int},
{func: "args0"},
...
function dart_precompiled($collectedClasses) {
  ...
  function Release(htmlUrl, tarballUrl, zipballUrl, id, tagName, targetCommitsh, name, body, description, draft, prerelease, createdAt, publishedAt, author, assets) {
    this.htmlUrl = htmlUrl;
    this.tarballUrl = tarballUrl;
    this.zipballUrl = zipballUrl;
    this.id = id;
    this.tagName = tagName;
    this.targetCommitsh = targetCommitsh;
    this.name = name;
    this.body = body;
  ...
  Release.builtin$cls = "Release";
  if (!"name" in Release)
    Release.name = "Release";
  $desc = $collectedClasses.Release;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Release.prototype = $desc;
  Release.prototype.get$tarballUrl = function() {
    return this.tarballUrl;
  };
  Release.prototype.get$id = function(receiver) {
    return this.id;
  };
  Release.prototype.get$tagName = function(receiver) {
    return this.tagName;
  };
  Release.prototype.get$name = function(receiver) {
    return this.name;
  };
  function Release_fromJSON_closure() {
  }
  Release_fromJSON_closure.builtin$cls = "Release_fromJSON_closure";
  if (!"name" in Release_fromJSON_closure)
    Release_fromJSON_closure.name = "Release_fromJSON_closure";
  $desc = $collectedClasses.Release_fromJSON_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Release_fromJSON_closure.prototype = $desc;
  function ReleaseAsset(browserDownloadUrl, id, name, label, state, contentType, size, downloadCount, createdAt, updatedAt) {
  ...
  ReleaseAsset.builtin$cls = "ReleaseAsset";
  if (!"name" in ReleaseAsset)
    ReleaseAsset.name = "ReleaseAsset";
  $desc = $collectedClasses.ReleaseAsset;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ReleaseAsset.prototype = $desc;
  ReleaseAsset.prototype.get$id = function(receiver) {
    return this.id;
  };
  ReleaseAsset.prototype.get$name = function(receiver) {
    return this.name;
  };
