...
["dart.collection", "dart:collection", , P, {
  ...
  SetMixin: {
    ...
    addAll$1: function(_, elements) {
      var t1;
      for (t1 = new J.ArrayIterator(elements, elements.length, 0, null); t1.moveNext$0();)
        this.add$1(0, t1.__interceptors$_current);
    },
    map$1: function(_, f) {
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AnimationPlayerEvent|ApplicationCacheErrorEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|ExtendableEvent|FontFaceSetLoadEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaQueryListEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|RTCPeerConnectionIceEvent|RelatedEvent|ResourceProgressEvent|SpeechRecognitionEvent|SpeechSynthesisEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
...
["github.common", "package:github/common.dart", , T, {
  ...
  GitHub: {
    ...
    getJSON$6$convert$fail$headers$params$statusCode: function(path, convert, fail, headers, params, statusCode) {
      var t1 = {};
      t1._captured_convert_0 = convert;
  ...
  GitHub_getJSON_closure0: {
    "^": "Closure:2;_common$_box_0",
    call$1: function(response) {
      return this._common$_box_0._captured_convert_0.call$1(C.JsonCodec_null_null.decode$1(J.get$body$x(response)));
    }
  },
  ...
  GitHub_request_closure2: {
    ...
    call$1: function(response) {
      var t1, t2;
      t1 = this._captured_statusCode_3;
      if (t1 != null) {
  ...
  User: {
    ...
    static: {User_fromJSON: [function(input) {
        ...
        return t2;
      }, "call$1", "User_fromJSON$closure", 2, 0, 39]}
  },
  UsersService: {
    "^": "Service;_github"
  },
  ...
  PaginationHelper: {
    ...
    objects$4$pages: function(method, path, converter, pages) {
      return this.objects$10$body$headers$pages$params$reverse$start$statusCode(method, path, converter, null, null, pages, null, false, null, 200);
    }
  },
  ...
  PaginationHelper_fetchStreamed_handleResponse: {
    ...
    call$1: function(response) {
      ...
      ++t1._captured_count_1;
      t2 = this._captured_controller_9;
      ...
      t3 = this._captured_reverse_8;
      if (!info.containsKey$1(t3 ? "prev" : "next")) {
        t2.close$0(0);
        return;
      }
      if (t1._captured_count_1 === this._captured_pages_7) {
        t2.close$0(0);
        return;
      }
...
["html_common", "dart:html_common", , P, {
  ...
  CssClassSetImpl_addAll_closure: {
    "^": "Closure:2;_captured_iterable_0",
    call$1: function(s) {
      return s.addAll$1(0, this._captured_iterable_0);
    }
  }
}],
["", "users.dart", , L, {
  ...
  loadUsers: function() {
    ...
    t2 = H.setRuntimeTypeInfo(new P._TakeStream(12, new T.PaginationHelper($.get$github().get$users()._github).objects$4$pages("GET", "/users", T.User_fromJSON$closure(), 2)), [null]);
    t2._createSubscription$4(new L.loadUsers_closure(t1), null, null, false);
  },
  main_closure: {
    "^": "Closure:0;",
    call$0: function() {
  ...
  loadUsers_closure: {
    "^": "Closure:31;_users$_box_0",
    call$1: function(baseUser) {
      var t1, t2;
      t1 = $.get$github().get$users();
      t2 = baseUser.get$login();
      t1._github.getJSON$2$convert("/users/" + H.S(t2), T.User_fromJSON$closure()).then$1(new L.loadUsers__closure(this._users$_box_0, baseUser));
    }
  },
  loadUsers__closure: {
    "^": "Closure:2;_users$_box_0,_captured_baseUser_1",
    call$1: function(user) {
      ...
      h.appendChild(e);
      t1 = "Username: <a href=\"" + H.S(this._captured_baseUser_1.htmlUrl) + "\">" + H.S(user.login);
      t1 + "</a>";
      t1 += "</a>\n";
      t2 = user.createdAt;
