...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMImplementation|MediaError|MediaKeyError|Navigator|NavigatorCPU|PositionError|Range|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:25;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AnimationPlayerEvent|ApplicationCacheErrorEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|FontFaceSetLoadEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|ProgressEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|RelatedEvent|ResourceProgressEvent|SecurityPolicyViolationEvent|SpeechRecognitionEvent|StorageEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent|XMLHttpRequestProgressEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
...
["github.common", "package:github/common.dart", , T, {
  ...
  buildQueryString: function(params) {
    ...
    for (t1 = params.get$keys(), t1 = t1.get$iterator(t1), i = 0; t1.moveNext$0();) {
      ...
      if (params.$index(0, key) == null)
        continue;
      t2 = H.S(key) + "=" + H.S(P.Uri__uriEncode(C.List_KIf, J.toString$0(params.$index(0, key)), C.Utf8Codec_false, false));
  ...
  GitHub: {
    ...
    request$5$body$headers$params: function(_, method, path, body, headers, params) {
      ...
      queryString = T.buildQueryString(params);
      url = P.StringBuffer$("");
  ...
  Repository: {
    "^": "Object;name>,id,fullName,owner,isPrivate,isFork,htmlUrl<,description,cloneUrls,homepage,size>,stargazersCount<,watchersCount,language,hasIssues,hasWiki,hasDownloads,forksCount<,openIssuesCount,defaultBranch,subscribersCount,networkCount,createdAt<,pushedAt<",
    static: {Repository_fromJSON: [function(input, instance) {
        var t1;
        if (input == null)
          return;
        instance = new T.Repository(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        ...
        instance.htmlUrl = t1.$index(input, "html_url");
        instance.description = t1.$index(input, "description");
        instance.cloneUrls = T.CloneUrls_fromJSON(input);
        ...
        instance.createdAt = T.parseDateTime(t1.$index(input, "created_at"));
        instance.pushedAt = T.parseDateTime(t1.$index(input, "pushed_at"));
        instance.isPrivate = t1.$index(input, "private");
        instance.owner = T.UserInformation_fromJSON(t1.$index(input, "owner"));
        return instance;
      }, function(input) {
        return T.Repository_fromJSON(input, null);
      }, null, "call$2", "call$1", "Repository_fromJSON$closure", 2, 2, 13, 6]}
  },
  CloneUrls: {
    "^": "Object;git,ssh,https,svn",
    static: {CloneUrls_fromJSON: function(input) {
        var t1, t2;
        if (input == null)
          return;
        t1 = new T.CloneUrls(null, null, null, null);
        t2 = J.getInterceptor$asx(input);
        t1.git = t2.$index(input, "git_url");
        t1.ssh = t2.$index(input, "ssh_url");
        t1.https = t2.$index(input, "clone_url");
        t1.svn = t2.$index(input, "svn_url");
        return t1;
      }}
  },
  UserInformation: {
    "^": "Object;login,id,avatarUrl,htmlUrl<",
    static: {UserInformation_fromJSON: function(input) {
        var t1, t2;
        if (input == null)
          return;
        t1 = new T.UserInformation(null, null, null, null);
        t2 = J.getInterceptor$asx(input);
  ...
  PaginationHelper_fetchStreamed_actualFetch: {
    "^": "Closure:36;box_0,this_1,method_2,start_3,params_4,body_5",
  ...
  PaginationHelper_fetchStreamed_closure: {
    "^": "Closure:37;box_0,pages_6,reverse_7,controller_8,actualFetch_9",
...
["", "repos.dart", , D, {
  ...
  updateRepos: function(repos, compare) {
    ...
    for (t1 = t1.get$iterator(repos); t1.moveNext$0();) {
      ...
      t3 = "        <div class=\"repo\" id=\"repo_" + H.S(t3.get$name(repo)) + "\">\n          <div class=\"line\"></div>\n          <h2><a href=\"" + H.S(repo.get$htmlUrl()) + "\">" + H.S(t3.get$name(repo)) + "</a></h2>\n          ";
      t3 = t3 + (!J.$eq(repo.description, "") && repo.description != null ? "<b>Description</b>: " + H.S(repo.description) + "<br/>" : "") + "\n          <b>Language</b>: ";
      t4 = repo.language;
  ...
  loadRepos: function(compare) {
    var t1, title, t2, t3, user, sorter, params;
    t1 = {};
    ...
    t2 = P.Uri_parse(window.location.href);
    t3 = t2._queryParameters;
    if (t3 == null) {
      t3 = t2._query;
      t3 = H.setRuntimeTypeInfo(new P.UnmodifiableMapView(P.Uri_splitQueryString(t3 == null ? "" : t3, C.Utf8Codec_false)), [null, null]);
      t2._queryParameters = t3;
      t2 = t3;
    } else
      t2 = t3;
    t2 = t2._map;
    user = t2.containsKey$1("user") === true ? t2.$index(0, "user") : "DirectMyFile";
    if (t2.containsKey$1("forks") === true)
      if (C.JSArray_methods.contains$1(["1", "true", "yes", "sure"], t2.$index(0, "forks")))
        ;
    if (t2.containsKey$1("sort") === true && t1.compare_0 == null) {
      sorter = t2.$index(0, "sort");
    ...
    t3 = t2._repositories;
    if (t3 == null) {
      t3 = new T.RepositoriesService(t2);
      t2._repositories = t3;
      t2 = t3;
    } else
      t2 = t3;
    t2.toString;
    params = P.LinkedHashMap_LinkedHashMap$_literal(["type", "owner", "sort", "full_name", "direction", "asc"], null, null);
    new T.PaginationHelper(t2._github).objects$4$params("GET", "/users/" + H.S(user) + "/repos", T.Repository_fromJSON$closure(), params).toList$0(0).then$1(new D.loadRepos_closure0(t1));
  },
  closure: {
    "^": "Closure:40;",
    call$2: function(a, b) {
...
{func: "Repository__dynamic__Repository", ret: T.Repository, args: [null], opt: [T.Repository]},
{func: "int_", ret: P.$int},
{func: "args0"},
...
function dart_precompiled($collectedClasses) {
  ...
  Headers.prototype.get$size = function(receiver) {
    return receiver.size;
  };
  ...
  function init_closure0(onReady_1, stopwatch_2) {
  ...
  function init_closure(script_3) {
  ...
  function Repository(name, id, fullName, owner, isPrivate, isFork, htmlUrl, description, cloneUrls, homepage, size, stargazersCount, watchersCount, language, hasIssues, hasWiki, hasDownloads, forksCount, openIssuesCount, defaultBranch, subscribersCount, networkCount, createdAt, pushedAt) {
    this.name = name;
    this.id = id;
  ...
  Repository.builtin$cls = "Repository";
  if (!"name" in Repository)
    Repository.name = "Repository";
  $desc = $collectedClasses.Repository;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Repository.prototype = $desc;
  Repository.prototype.get$name = function(receiver) {
    return this.name;
  };
  Repository.prototype.get$htmlUrl = function() {
    return this.htmlUrl;
  };
  Repository.prototype.get$size = function(receiver) {
    return this.size;
  };
  Repository.prototype.get$stargazersCount = function() {
    return this.stargazersCount;
  };
  Repository.prototype.get$forksCount = function() {
    return this.forksCount;
  };
  Repository.prototype.get$createdAt = function() {
    return this.createdAt;
  };
  Repository.prototype.get$pushedAt = function() {
    return this.pushedAt;
  };
  function CloneUrls(git, ssh, https, svn) {
    this.git = git;
    this.ssh = ssh;
    this.https = https;
    this.svn = svn;
  }
  CloneUrls.builtin$cls = "CloneUrls";
  if (!"name" in CloneUrls)
    CloneUrls.name = "CloneUrls";
  $desc = $collectedClasses.CloneUrls;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CloneUrls.prototype = $desc;
  function UserInformation(login, id, avatarUrl, htmlUrl) {
    this.login = login;
    this.id = id;
    this.avatarUrl = avatarUrl;
    this.htmlUrl = htmlUrl;
  }
  UserInformation.builtin$cls = "UserInformation";
  if (!"name" in UserInformation)
    UserInformation.name = "UserInformation";
  $desc = $collectedClasses.UserInformation;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UserInformation.prototype = $desc;
  UserInformation.prototype.get$htmlUrl = function() {
    return this.htmlUrl;
  };
  function RepositoriesService(_github) {
    this._github = _github;
  }
  RepositoriesService.builtin$cls = "RepositoriesService";
  if (!"name" in RepositoriesService)
    RepositoriesService.name = "RepositoriesService";
  $desc = $collectedClasses.RepositoriesService;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RepositoriesService.prototype = $desc;
  ...
  function main_closure(stopwatch_0) {
    this.stopwatch_0 = stopwatch_0;
  }
