...
["dart.dom.html", "dart:html", , W, {
  ...
  Event: {
    "^": "Interceptor;",
    "%": "AnimationPlayerEvent|AudioProcessingEvent|AutocompleteErrorEvent|BeforeUnloadEvent|CSSFontFaceLoadEvent|CloseEvent|CustomEvent|DeviceLightEvent|DeviceMotionEvent|DeviceOrientationEvent|GamepadEvent|HashChangeEvent|IDBVersionChangeEvent|InstallEvent|InstallPhaseEvent|MIDIConnectionEvent|MediaKeyEvent|MediaKeyMessageEvent|MediaKeyNeededEvent|MediaStreamEvent|MediaStreamTrackEvent|MutationEvent|OfflineAudioCompletionEvent|OverflowEvent|PageTransitionEvent|PopStateEvent|RTCDTMFToneChangeEvent|RTCDataChannelEvent|RTCIceCandidateEvent|SecurityPolicyViolationEvent|SpeechRecognitionEvent|TrackEvent|TransitionEvent|WebGLContextEvent|WebKitAnimationEvent|WebKitTransitionEvent;ClipboardEvent|Event|InputEvent"
  },
  EventTarget: {
    "^": "Interceptor;",
...
["github.common", "package:github/common.dart", , T, {
  ...
  PaginationHelper_objects_closure0: {
    "^": "Closure:17;this_0,converter_1,controller_2",
    call$1: function(response) {
  ...
  Repository: {
    "^": "Object;github,name>,id,fullName,owner,isPrivate,isFork,url>,description<,cloneUrls,homepage,size>,stargazersCount<,watchersCount,language>,hasIssues,hasWiki,hasDownloads,forksCount<,openIssuesCount,defaultBranch,subscribersCount,networkCount,createdAt<,pushedAt<,json",
    static: {Repository_fromJSON: [function(github, input, instance) {
        ...
        instance.json = input;
        instance.owner = T.UserInformation_fromJSON(github, t1.$index(input, "owner"));
        return instance;
  ...
  UserInformation: {
    "^": "Object;github,login,id,avatarUrl,url>",
    static: {UserInformation_fromJSON: function(github, input) {
        var owner, t1;
        if (input == null)
          return;
        owner = new T.UserInformation(github, null, null, null, null);
        t1 = J.getInterceptor$asx(input);
...
["", "repos.dart", , D, {
  ...
  main: [function() {
    ...
    $.github = new T.GitHub(new T.Authentication("5fdec2b77527eae85f188b7b2bfeeda170f26883", null, null, false, false, true), "https://api.github.com", t1, null);
  ...
  loadRepos: function(compare) {
    ...
    new T.PaginationHelper(t2).objects$4$params("GET", "/users/" + H.S(user) + "/repos", T.Repository_fromJSON$closure(), params).toList$0(0).then$1(new D.loadRepos_closure0(t1));
  },
  closure: {
    "^": "Closure:40;",
    call$2: function(a, b) {
...
function dart_precompiled($collectedClasses) {
  ...
  HeaderMap.prototype.get$size = function(receiver) {
    return receiver.size;
  };
  ...
  Request0.prototype.get$url = function(receiver) {
    return receiver.url;
  };
  ...
  function Repository(github, name, id, fullName, owner, isPrivate, isFork, url, description, cloneUrls, homepage, size, stargazersCount, watchersCount, language, hasIssues, hasWiki, hasDownloads, forksCount, openIssuesCount, defaultBranch, subscribersCount, networkCount, createdAt, pushedAt, json) {
    this.github = github;
    this.name = name;
    this.id = id;
  ...
  Repository.prototype.get$url = function(receiver) {
    return this.url;
  };
  Repository.prototype.get$description = function() {
  ...
  Repository.prototype.get$language = function(receiver) {
  ...
  function UserInformation(github, login, id, avatarUrl, url) {
    this.github = github;
    this.login = login;
    this.id = id;
  ...
  UserInformation.prototype.get$url = function(receiver) {
    return this.url;
  };
