...
function dart_precompiled($collectedClasses) {
  ...
  function Repository(github, name, id, fullName, owner, $private, isFork, url, description, cloneUrls, homepage, size, stargazersCount, watchersCount, language, hasIssues, hasWiki, hasDownloads, forksCount, openIssuesCount, defaultBranch, subscribersCount, networkCount, createdAt, pushedAt, json) {
    this.github = github;
    this.name = name;
    this.id = id;
  ...
  function RepositoryOwner(login, id, avatarUrl, url) {
    this.login = login;
    this.id = id;
    this.avatarUrl = avatarUrl;
    this.url = url;
  }
  RepositoryOwner.builtin$cls = "RepositoryOwner";
  if (!"name" in RepositoryOwner)
    RepositoryOwner.name = "RepositoryOwner";
  $desc = $collectedClasses.RepositoryOwner;
  if ($desc instanceof Array)
    $desc = $desc[1];
  RepositoryOwner.prototype = $desc;
  RepositoryOwner.prototype.get$url = function(receiver) {
    return this.url;
  };
