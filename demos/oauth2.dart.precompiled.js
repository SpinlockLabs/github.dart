...
["", "oauth2.dart", , T, {
  ...
  main_authorize: {
    ...
    call$0: function() {
      var t1 = this.flow_1;
      window.location.href = t1.baseUrl + "/authorize" + T.buildQueryString(P.LinkedHashMap_LinkedHashMap$_literal(["client_id", t1.clientId, "scopes", C.JSArray_methods.join$1(t1.scopes, ","), "redirect_uri", t1.redirectUri, "state", t1.state], null, null));
    }
  },
  main_closure: {
