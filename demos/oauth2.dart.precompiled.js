...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMImplementation|MediaError|MediaKeyError|Navigator|NavigatorCPU|PositionError|Request|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["", "oauth2.dart", , T, {
  ...
  loadUsername: function(token) {
    var t1 = $.GitHub_defaultClient.call$0();
    new T.GitHub(new T.Authentication(token, null, null, false, false, true), "https://api.github.com", t1, null).currentUser$0().then$1(new T.loadUsername_closure());
  },
  main_authorize: {
    "^": "Closure:3;flow_1",
    call$0: function() {
      var t1 = this.flow_1;
      window.location.href = C.JSString_methods.$add(t1.baseUrl + "/authorize", M.buildQueryString(P.LinkedHashMap_LinkedHashMap$_literal(["client_id", t1.clientId, "scopes", C.JSArray_methods.join$1(t1.scopes, ","), "redirect_uri", t1.redirectUri, "state", t1.state], null, null)));
    },
    $isFunction: true
  },
  main_closure: {
    ...
    call$0: function() {
      ...
      t2 = $.Zone__current;
      t3 = P._registerErrorHandler(new T.main__closure0(this.authorize_3), t2);
      t2.toString;
...
function dart_precompiled($collectedClasses) {
  ...
  function GitHub_currentUser_closure(this_0) {
    this.this_0 = this_0;
  }
  GitHub_currentUser_closure.builtin$cls = "GitHub_currentUser_closure";
  if (!"name" in GitHub_currentUser_closure)
    GitHub_currentUser_closure.name = "GitHub_currentUser_closure";
  $desc = $collectedClasses.GitHub_currentUser_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  GitHub_currentUser_closure.prototype = $desc;
  ...
  function UserPlan(github, name, space, privateReposCount, collaboratorsCount) {
    this.github = github;
    this.name = name;
    this.space = space;
  ...
  function CurrentUser(privateReposCount, ownedPrivateReposCount, diskUsage, plan, github, login, id, avatarUrl, url, siteAdmin, name, company, blog, location, email, hirable, bio, publicReposCount, publicGistsCount, followersCount, followingCount, createdAt, updatedAt, json) {
    this.privateReposCount = privateReposCount;
