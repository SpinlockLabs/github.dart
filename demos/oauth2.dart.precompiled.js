...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "DOMImplementation|MediaError|MediaKeyError|Navigator|NavigatorCPU|PositionError|Range|Request|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["github.common", "package:github/common.dart", , T, {
  ...
  CurrentUser: {
    ...
    static: {CurrentUser_fromJSON: [function(input) {
        ...
        return t1;
      }, "call$1", "CurrentUser_fromJSON$closure", 2, 0, 10]}
  },
  UserPlan: {
  ...
  UsersService: {
    ...
    getCurrentUser$0: function() {
      return this._github.getJSON$4$convert$fail$statusCode("/user", T.CurrentUser_fromJSON$closure(), new T.UsersService_getCurrentUser_closure(this), 200);
    }
  },
  UsersService_getCurrentUser_closure: {
    ...
    call$1: function(response) {
      if (J.get$statusCode$x(response) === 403)
        throw H.wrapException(T.AccessForbidden$(this.this_0._github));
    },
    $isFunction: true
  },
  Authentication: {
  ...
  OAuth2Flow: {
    "^": "Object;clientId,scopes,redirectUri,state,clientSecret,baseUrl,github",
    exchange$2: function(code, origin) {
      var headers, body, t1;
      headers = P.LinkedHashMap_LinkedHashMap$_literal(["Accept", "application/json", "content-type", "application/json"], null, null);
      ...
      return J.request$1$x(t1, new T.Request(this.baseUrl + "/access_token", "POST", body, headers)).then$1(new T.OAuth2Flow_exchange_closure());
    },
...
["", "oauth2.dart", , T, {
  ...
  main: [function() {
    ...
    flow = new T.OAuth2Flow("ff718b16cbfc71defcba", ["user:email"], t2, null, "a0c004e014feed76bdd659fcef0445e8f632c236", "https://github.com/login/oauth", null);
  ...
  loadUsername: function(token) {
    ...
    t1 = new T.UsersService(github);
    github._users = t1;
    t1.getCurrentUser$0().then$1(new T.loadUsername_closure());
  },
  main_authorize: {
    "^": "Closure:3;flow_1",
    call$0: function() {
      var t1 = this.flow_1;
      window.location.href = C.JSString_methods.$add(t1.baseUrl + "/authorize", T.buildQueryString(P.LinkedHashMap_LinkedHashMap$_literal(["client_id", t1.clientId, "scopes", C.JSArray_methods.join$1(t1.scopes, ","), "redirect_uri", t1.redirectUri, "state", t1.state], null, null)));
    },
    $isFunction: true
  },
  main_closure: {
    "^": "Closure:12;box_0,flow_2,authorize_3",
    call$0: function() {
      var t1, onError, result, t2;
      t1 = this.flow_2.exchange$1(J.$index$asx(this.box_0.params_0, "code")).then$1(new T.main__closure());
      onError = new T.main__closure0(this.authorize_3);
      result = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
      t2 = result._zone;
      if (t2 !== C.C__RootZone)
...
{func: "CurrentUser__dynamic", ret: T.CurrentUser, args: [null]},
{func: "int_", ret: P.$int},
{func: "args0"},
...
function dart_precompiled($collectedClasses) {
  ...
  function CurrentUser(privateReposCount, ownedPrivateReposCount, diskUsage, plan, login, id, avatarUrl, htmlUrl, siteAdmin, name, company, blog, location, email, hirable, bio, publicReposCount, publicGistsCount, followersCount, followingCount, createdAt, updatedAt) {
  ...
  CurrentUser.builtin$cls = "CurrentUser";
  if (!"name" in CurrentUser)
    CurrentUser.name = "CurrentUser";
  $desc = $collectedClasses.CurrentUser;
  if ($desc instanceof Array)
    $desc = $desc[1];
  CurrentUser.prototype = $desc;
  function UserPlan(name, space, privateReposCount, collaboratorsCount) {
    this.name = name;
    this.space = space;
    this.privateReposCount = privateReposCount;
    this.collaboratorsCount = collaboratorsCount;
  }
  UserPlan.builtin$cls = "UserPlan";
  if (!"name" in UserPlan)
    UserPlan.name = "UserPlan";
  $desc = $collectedClasses.UserPlan;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UserPlan.prototype = $desc;
  UserPlan.prototype.get$name = function(receiver) {
    return this.name;
  };
  ...
  function UsersService_getCurrentUser_closure(this_0) {
    this.this_0 = this_0;
  }
  UsersService_getCurrentUser_closure.builtin$cls = "UsersService_getCurrentUser_closure";
  if (!"name" in UsersService_getCurrentUser_closure)
    UsersService_getCurrentUser_closure.name = "UsersService_getCurrentUser_closure";
  $desc = $collectedClasses.UsersService_getCurrentUser_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  UsersService_getCurrentUser_closure.prototype = $desc;
  ...
  Authentication.prototype.get$token = function() {
    return this.token;
  };
  ...
  function OAuth2Flow(clientId, scopes, redirectUri, state, clientSecret, baseUrl, github) {
  ...
  OAuth2Flow.builtin$cls = "OAuth2Flow";
  if (!"name" in OAuth2Flow)
    OAuth2Flow.name = "OAuth2Flow";
  $desc = $collectedClasses.OAuth2Flow;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OAuth2Flow.prototype = $desc;
  function OAuth2Flow_exchange_closure() {
  }
  OAuth2Flow_exchange_closure.builtin$cls = "OAuth2Flow_exchange_closure";
  if (!"name" in OAuth2Flow_exchange_closure)
    OAuth2Flow_exchange_closure.name = "OAuth2Flow_exchange_closure";
  $desc = $collectedClasses.OAuth2Flow_exchange_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  OAuth2Flow_exchange_closure.prototype = $desc;
  function ExchangeResponse(token, scopes, tokenType) {
    this.token = token;
    this.scopes = scopes;
    this.tokenType = tokenType;
  }
  ExchangeResponse.builtin$cls = "ExchangeResponse";
  if (!"name" in ExchangeResponse)
    ExchangeResponse.name = "ExchangeResponse";
  $desc = $collectedClasses.ExchangeResponse;
  if ($desc instanceof Array)
    $desc = $desc[1];
  ExchangeResponse.prototype = $desc;
  ExchangeResponse.prototype.get$token = function() {
    return this.token;
  };
  function Service() {
  }
  ...
  function main_authorize(flow_1) {
    this.flow_1 = flow_1;
  }
  main_authorize.builtin$cls = "main_authorize";
  if (!"name" in main_authorize)
    main_authorize.name = "main_authorize";
  $desc = $collectedClasses.main_authorize;
  if ($desc instanceof Array)
    $desc = $desc[1];
  main_authorize.prototype = $desc;
  function main_closure(box_0, flow_2, authorize_3) {
    this.box_0 = box_0;
    this.flow_2 = flow_2;
    this.authorize_3 = authorize_3;
  }
  ...
  function main__closure0(authorize_4) {
    this.authorize_4 = authorize_4;
  }
