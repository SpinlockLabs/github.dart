...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 32, 0],
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 31],
    ...
    Release: {
      ...
      static: {Release_fromJSON: [function(input) {
          ...
          return t1;
        }, "call$1", "common_Release_fromJSON$closure", 2, 0, 21]}
    },
    ...
    }, "call$0", "releases__main$closure", 0, 0, 2],
    loadReleases: function() {
      ...
      if (t2 == null) {
        ...
        t1 = t2;
      J.toList$0$ax(new T.PaginationHelper(t1._github).objects$3("GET", "/repos/twbs/bootstrap/releases", T.common_Release_fromJSON$closure())).then$1(new T.loadReleases_closure());
    },
    main_closure: {
      "^": "Closure:0;",
      call$0: function() {
    ...
    loadReleases_closure: {
      ...
      call$1: function(releases) {
        ...
        for (t1 = J.get$iterator$ax(releases); t1.moveNext$0();) {
          ...
          J.insertAdjacentHtml$4$treeSanitizer$validator$x($.$releases, "beforeend", "      <div class=\"repo box\" id=\"release-" + H.S(t2.get$id(release)) + "\">\n        <h1>" + H.S(t2.get$name(release)) + "</h1>\n      </div>\n      ", null, null);
          t2 = new T.loadReleases__append($.$releases.querySelector("#release-" + H.S(t2.get$id(release))));
          t2.call$2("Tag", "<a href=" + H.S(release.get$htmlUrl()) + ">" + H.S(release.tagName) + "</a>");
          t2.call$2("Download", "<a href=\"" + H.S(release.tarballUrl) + "\">TAR</a> | <a href=\"" + H.S(release.zipballUrl) + "\">ZIP</a>");
        }
      }
    },
    loadReleases__append: {
      "^": "Closure:29;_captured_rel_0",
      call$2: function(key, value) {
        J.insertAdjacentHtml$4$treeSanitizer$validator$x(this._captured_rel_0, "beforeend", "<br/><b>" + key + "</b>: " + value, null, null);
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, void: true}, {func: 1, args: [,,]}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [P.$int,,]}, {func: 1, void: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.$int, args: [,]}, {func: 1, args: [P.$int]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, void: true, args: [P.$int, P.$int]}, {func: 1, args: [P.Symbol,,]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, ret: P.bool}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, ret: T.Release, args: [,]}, {func: 1, void: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, void: true, args: [W.Node, W.Node]}, {func: 1, args: [, P.String]}, {func: 1, void: true, args: [P.Object, P.StackTrace]}, {func: 1, void: true, args: [P.String]}, {func: 1, void: true, args: [P.String,,]}, {func: 1, ret: P.num}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [P.String]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(T.releases__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(T.releases__main$closure(), a);
