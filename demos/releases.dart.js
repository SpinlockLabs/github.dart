...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _AsyncRun__initializeScheduleImmediate_closure: {
      "^": "Closure:12;_box_0,_captured_div_1,_captured_span_2",
    ...
    Release: {
      ...
      static: {Release_fromJSON: [function(input) {
          ...
          return t1;
        }, "call$1", "common_Release_fromJSON$closure", 2, 0, 28]}
    },
    ...
    loadReleases: function() {
      ...
      if (t2 == null) {
        ...
        t1 = t2;
      J.map$1$ax(new T.PaginationHelper(t1._github).jsonObjects$8$body$headers$pages$params$preview$statusCode("GET", "/repos/twbs/bootstrap/releases", null, null, null, null, null, 200), T.common_Release_fromJSON$closure()).toList$0(0).then$1(new T.loadReleases_closure());
    },
    main_closure: {
      "^": "Closure:0;",
      call$0: function() {
    ...
    loadReleases__append: {
      "^": "Closure:26;_captured_rel_0",
      call$2: function(key, value) {
        J.insertAdjacentHtml$4$treeSanitizer$validator$x(this._captured_rel_0, "beforeend", "<br/><b>" + key + "</b>: " + value, C.C__TrustedHtmlTreeSanitizer, null);
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [P.bool]}, {func: 1, v: true, args: [P.Object, P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, v: true, args: [P.$int, P.$int]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [P.String,,]}, {func: 1, ret: P.num}, {func: 1, ret: T.Release, args: [,]}];
