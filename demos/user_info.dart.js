  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    CurrentUser: {
      ...
      static: {CurrentUser_fromJSON: [function(input) {
          ...
          return t1;
        }, "call$1", "common_CurrentUser_fromJSON$closure", 2, 0, 31]}
    },
    UserPlan: {
    ...
    UsersService_getCurrentUser_closure: {
      "^": "Closure:27;_common$_captured_this_0",
      call$1: function(response) {
    ...
    loadUser: function() {
      ...
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.loadUser_closure(token)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    main_closure: {
      "^": "Closure:0;",
      call$0: function() {
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.$int, args: [P.String]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, ret: P.bool, args: [W.Element, P.String, P.String, W._Html5NodeValidator]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [P.bool]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, ret: P.$int, args: [, P.$int]}, {func: 1, v: true, args: [P.$int, P.$int]}, {func: 1, ret: P.$int, args: [,,]}, {func: 1, v: true, args: [P.String]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, ret: P.$int, args: [P.$int, P.$int]}, {func: 1, args: [W.HttpRequest]}, {func: 1, v: true, args: [W.Node, W.Node]}, {func: 1, args: [T.Response]}, {func: 1, args: [T.CurrentUser]}, {func: 1, v: true, args: [P.String,,]}, {func: 1, ret: P.num}, {func: 1, ret: T.CurrentUser, args: [,]}];
