...
["", "user_info.dart", , U, {
  ...
  loadUser_closure: {
    ...
    call$1: function($event) {
      ...
      t2 = new T.GitHub(new T.Authentication(t1, null, null, false, false, true), "https://api.github.com", t2, null).currentUser$0().then$1(new U.loadUser__closure());
      t1 = $.Zone__current;
