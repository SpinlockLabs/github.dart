...
["github.common", "package:github/common.dart", , T, {
  ...
  CurrentUser: {
    ...
    static: {CurrentUser_fromJSON: [function(input) {
        ...
        return t1;
      }, "call$1", "CurrentUser_fromJSON$closure", 2, 0, 9]}
  },
  UserPlan: {
...
["", "user_info.dart", , U, {
  ...
  loadUser_closure: {
    "^": "Closure:13;token_0",
    call$1: function($event) {
      var t1, t2, github, onError, result;
      ...
      github._users = t1;
      t1 = t1.getCurrentUser$0().then$1(new U.loadUser__closure());
      onError = new U.loadUser__closure0();
      result = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
      t2 = result._zone;
      if (t2 !== C.C__RootZone)
...
function dart_precompiled($collectedClasses) {
  ...
  User.prototype.get$bio = function() {
    return this.bio;
  };
  ...
  CurrentUser.prototype.get$diskUsage = function() {
