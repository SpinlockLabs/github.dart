...
["github.common", "package:github/common.dart", , T, {
  ...
  User: {
    ...
    static: {User_fromJSON: [function(github, input) {
        ...
        t2.json = input;
        return t2;
      }, "call$2", "User_fromJSON$closure", 4, 0, 11]}
  }
}],
...
["", "stars.dart", , G, {
  ...
  loadStars: function() {
    ...
    $.github = new T.GitHub(new T.Authentication(token, null, null, false, false, true), "https://api.github.com", t1, null);
    t1 = document.querySelector("#title");
    t2 = " for " + H.S(user) + "/" + H.S(repo);
    t1.toString;
    t1.appendChild(document.createTextNode(t2));
    t2 = $.github;
    t2.toString;
    new T.PaginationHelper(t2).objects$3("GET", "/repos/" + (H.S(user) + "/" + H.S(repo)) + "/stargazers", T.User_fromJSON$closure()).listen$1(new G.loadStars_closure()).onDone$1(new G.loadStars_closure0());
  },
  main_closure: {
    "^": "Closure:13;",
    call$0: function() {
...
function dart_precompiled($collectedClasses) {
  ...
  function loadStars_closure() {
  }
  loadStars_closure.builtin$cls = "loadStars_closure";
  if (!"name" in loadStars_closure)
    loadStars_closure.name = "loadStars_closure";
  $desc = $collectedClasses.loadStars_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadStars_closure.prototype = $desc;
  function loadStars_closure0() {
  }
  loadStars_closure0.builtin$cls = "loadStars_closure0";
  if (!"name" in loadStars_closure0)
    loadStars_closure0.name = "loadStars_closure0";
  $desc = $collectedClasses.loadStars_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadStars_closure0.prototype = $desc;
