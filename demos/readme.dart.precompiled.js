...
function dart_precompiled($collectedClasses) {
  ...
  function FileLinks(git, self, html) {
    this.git = git;
    this.self = self;
    this.html = html;
  }
  FileLinks.builtin$cls = "FileLinks";
  if (!"name" in FileLinks)
    FileLinks.name = "FileLinks";
  $desc = $collectedClasses.FileLinks;
  if ($desc instanceof Array)
    $desc = $desc[1];
  FileLinks.prototype = $desc;
