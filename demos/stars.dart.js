...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Primitives_dateNow: [function() {
      return Date.now();
    }, "call$0", "_js_helper_Primitives_dateNow$closure", 0, 0, 26],
    ...
    User: {
      ...
      static: {User_fromJSON: [function(input) {
          ...
          return t2;
        }, "call$1", "common_User_fromJSON$closure", 2, 0, 27]}
    },
    Authentication: {
    ...
    loadStars: function() {
      ...
      J.map$1$ax(new T.PaginationHelper(t1._github).jsonObjects$8$body$headers$pages$params$preview$statusCode("GET", "/repos/" + (H.S(user) + "/" + H.S(repo)) + "/stargazers", null, null, null, null, null, 200), T.common_User_fromJSON$closure()).listen$1(new G.loadStars_closure()).onDone$1(new G.loadStars_closure0());
    },
    main_closure: {
      "^": "Closure:0;",
      call$0: function() {
    ...
    loadStars_closure: {
      ...
      call$1: function(stargazer) {
        ...
        J.set$textAlign$x(t1.get$style(h), "center");
        ...
        J.set$text$x(t1, stargazer.login);
        J.append$1$x(e, t1);
        h.appendChild(e);
        $.$stars.appendChild(h);
      }
