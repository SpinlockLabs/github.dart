...
["dart.convert", "dart:convert", , P, {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:21;this_1,codeUnits_2,startIndex_3,endIndex_4",
...
["", "emoji.dart", , U, {
  ...
  loadEmojis: function() {
    ...
    t1._misc = t2;
    t1 = t2;
    t1._github.getJSON$2$statusCode("/emojis", 200).then$1(new U.loadEmojis_closure());
  },
  filter: function(query) {
    var t1, boxes, box, t2, t;
    t1 = $.lastQuery;
    if (t1 != null && (t1 == null ? query == null : t1 === query))
      return;
    $.lastQuery = query;
    boxes = J.get$children$x($.$$emoji);
    for (t1 = boxes.get$iterator(boxes); t1.moveNext$0();) {
      box = t1.__internal$_current;
      t2 = J.getInterceptor$x(box);
      t = t2.querySelector$1(box, "p").textContent;
      if (C.JSString_methods.contains$1(J.substring$2$s(t, 1, t.length - 1), query))
        J.set$display$x(t2.get$style(box), "inline");
      else
        J.set$display$x(t2.get$style(box), "none");
    }
  },
  main_closure: {
    "^": "Closure:9;",
    call$0: function() {
      ...
      t1 = J.get$onKeyUp$x(searchBox);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.main__closure(searchBox)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    $isFunction: true
  },
  main__closure: {
    "^": "Closure:11;searchBox_0",
    call$1: function($event) {
      U.filter(J.get$value$x(this.searchBox_0));
    },
    $isFunction: true
  },
  loadEmojis_closure: {
...
function dart_precompiled($collectedClasses) {
  ...
  function main__closure(searchBox_0) {
    this.searchBox_0 = searchBox_0;
  }
  ...
  function loadEmojis_closure() {
  }
  loadEmojis_closure.builtin$cls = "loadEmojis_closure";
  if (!"name" in loadEmojis_closure)
    loadEmojis_closure.name = "loadEmojis_closure";
  $desc = $collectedClasses.loadEmojis_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadEmojis_closure.prototype = $desc;
  function loadEmojis__closure() {
  }
  loadEmojis__closure.builtin$cls = "loadEmojis__closure";
  if (!"name" in loadEmojis__closure)
    loadEmojis__closure.name = "loadEmojis__closure";
  $desc = $collectedClasses.loadEmojis__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  loadEmojis__closure.prototype = $desc;
  ...
  function GitHub_getJSON_closure1(box_0, this_1, statusCode_2, fail_3) {
    this.box_0 = box_0;
    this.this_1 = this_1;
