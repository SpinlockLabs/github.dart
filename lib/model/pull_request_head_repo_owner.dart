...
part 'pull_request_head_repo_owner.g.dart';

abstract class PullRequestHeadRepoOwner implements Built<PullRequestHeadRepoOwner, PullRequestHeadRepoOwnerBuilder> {
    ...
    PullRequestHeadRepoOwner._();

    static void _initializeBuilder(PullRequestHeadRepoOwnerBuilder b) => b;

    factory PullRequestHeadRepoOwner([void updates(PullRequestHeadRepoOwnerBuilder b)]) = _$PullRequestHeadRepoOwner;
    static Serializer<PullRequestHeadRepoOwner> get serializer => _$pullRequestHeadRepoOwnerSerializer;
}
