...
abstract class FullRepository implements Built<FullRepository, FullRepositoryBuilder> {
    ...
    Repository get templateRepository;
    ...
    @nullable
    @BuiltValueField(wireName: r'anonymous_access_enabled')
    ...
    static void _initializeBuilder(FullRepositoryBuilder b) => b
        ..anonymousAccessEnabled = true;

    factory FullRepository([void updates(FullRepositoryBuilder b)]) = _$FullRepository;
    static Serializer<FullRepository> get serializer => _$fullRepositorySerializer;
}
