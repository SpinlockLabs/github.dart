...
part 'pull_request_base_repo.g.dart';

abstract class PullRequestBaseRepo implements Built<PullRequestBaseRepo, PullRequestBaseRepoBuilder> {
    ...
    PullRequestBaseRepo._();

    static void _initializeBuilder(PullRequestBaseRepoBuilder b) => b;

    factory PullRequestBaseRepo([void updates(PullRequestBaseRepoBuilder b)]) = _$PullRequestBaseRepo;
    static Serializer<PullRequestBaseRepo> get serializer => _$pullRequestBaseRepoSerializer;
}
