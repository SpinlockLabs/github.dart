...
part 'issue_simple.g.dart';

abstract class IssueSimple implements Built<IssueSimple, IssueSimpleBuilder> {
    ...
    static void _initializeBuilder(IssueSimpleBuilder b) => b;

    factory IssueSimple([void updates(IssueSimpleBuilder b)]) = _$IssueSimple;
    static Serializer<IssueSimple> get serializer => _$issueSimpleSerializer;
}
