...
Serializer<PublicUser> _$publicUserSerializer = new _$PublicUserSerializer();

class _$PublicUserSerializer implements StructuredSerializer<PublicUser> {
  @override
  final Iterable<Type> types = const [PublicUser, _$PublicUser];
  @override
  final String wireName = 'PublicUser';

  @override
  Iterable<Object> serialize(Serializers serializers, PublicUser object,
  ...
  @override
  PublicUser deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new PublicUserBuilder();
...
class _$PublicUser extends PublicUser {
  ...
  factory _$PublicUser([void Function(PublicUserBuilder) updates]) =>
      (new PublicUserBuilder()..update(updates)).build();
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, login.hashCode), id.hashCode), nodeId.hashCode), avatarUrl.hashCode), gravatarId.hashCode), url.hashCode), htmlUrl.hashCode), followersUrl.hashCode), followingUrl.hashCode), gistsUrl.hashCode), starredUrl.hashCode), subscriptionsUrl.hashCode), organizationsUrl.hashCode), reposUrl.hashCode), eventsUrl.hashCode), receivedEventsUrl.hashCode), type.hashCode), siteAdmin.hashCode), name.hashCode), company.hashCode),
                                                                                blog.hashCode),
                                                                            location.hashCode),
                                                                        email.hashCode),
                                                                    hireable.hashCode),
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PublicUser')
          ..add('login', login)
          ..add('id', id)
          ..add('nodeId', nodeId)
...
class PublicUserBuilder implements Builder<PublicUser, PublicUserBuilder> {
  ...
  PublicUserBuilder() {
    PublicUser._initializeBuilder(this);
  }
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            'PublicUser', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
