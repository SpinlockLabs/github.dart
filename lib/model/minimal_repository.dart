...
abstract class MinimalRepository implements Built<MinimalRepository, MinimalRepositoryBuilder> {
    ...
    MinimalRepositoryLicense get license;
    ...
    static void _initializeBuilder(MinimalRepositoryBuilder b) => b;

    factory MinimalRepository([void updates(MinimalRepositoryBuilder b)]) = _$MinimalRepository;
    static Serializer<MinimalRepository> get serializer => _$minimalRepositorySerializer;
}
