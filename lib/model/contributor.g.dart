...
Serializer<Contributor> _$contributorSerializer = new _$ContributorSerializer();

class _$ContributorSerializer implements StructuredSerializer<Contributor> {
  @override
  final Iterable<Type> types = const [Contributor, _$Contributor];
  @override
  final String wireName = 'Contributor';

  @override
  Iterable<Object> serialize(Serializers serializers, Contributor object,
    ...
    if (object.contributions != null) {
      result
        ..add('contributions')
        ..add(serializers.serialize(object.contributions,
            specifiedType: const FullType(int)));
    }
  ...
  @override
  Contributor deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ContributorBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'site_admin':
          ...
          break;
        case 'contributions':
          result.contributions = serializers.deserialize(value,
              specifiedType: const FullType(int)) as int;
          break;
        case 'email':
...
class _$Contributor extends Contributor {
  ...
  factory _$Contributor([void Function(ContributorBuilder) updates]) =>
      (new ContributorBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('Contributor')
          ..add('login', login)
          ..add('id', id)
          ..add('nodeId', nodeId)
...
class ContributorBuilder implements Builder<Contributor, ContributorBuilder> {
  ...
  int _contributions;
  int get contributions => _$this._contributions;
  set contributions(int contributions) => _$this._contributions = contributions;
  ...
  ContributorBuilder() {
    Contributor._initializeBuilder(this);
  }
  ...
  ContributorBuilder get _$this {
    if (_$v != null) {
      ...
      _contributions = _$v.contributions;
      _email = _$v.email;
      _name = _$v.name;
      _$v = null;
    }
