...
Serializer<SimpleUser> _$simpleUserSerializer = new _$SimpleUserSerializer();
...
class _$SimpleUserSerializer implements StructuredSerializer<SimpleUser> {
  ...
  @override
  final String wireName = 'SimpleUser';
  ...
  SimpleUser deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SimpleUserBuilder();
...
class _$SimpleUser extends SimpleUser {
  ...
  factory _$SimpleUser([void Function(SimpleUserBuilder) updates]) =>
      (new SimpleUserBuilder()..update(updates)).build();
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('SimpleUser')
          ..add('login', login)
          ..add('id', id)
          ..add('nodeId', nodeId)
...
class SimpleUserBuilder implements Builder<SimpleUser, SimpleUserBuilder> {
  ...
  SimpleUserBuilder() {
    SimpleUser._initializeBuilder(this);
  }
