    ...
    if (object.templateRepository != null) {
      result
        ...
        ..add(serializers.serialize(object.templateRepository,
            specifiedType: const FullType(RepositoryTemplateRepository)));
    }
      ...
      switch (key) {
        ...
        case 'template_repository':
          result.templateRepository.replace(serializers.deserialize(value,
                  specifiedType: const FullType(RepositoryTemplateRepository))
              as RepositoryTemplateRepository);
          break;
...
class _$Repository extends Repository {
  ...
  @override
  final RepositoryTemplateRepository templateRepository;
  @override
...
class RepositoryBuilder implements Builder<Repository, RepositoryBuilder> {
  ...
  RepositoryTemplateRepositoryBuilder _templateRepository;
  RepositoryTemplateRepositoryBuilder get templateRepository =>
      _$this._templateRepository ??= new RepositoryTemplateRepositoryBuilder();
  set templateRepository(
          RepositoryTemplateRepositoryBuilder templateRepository) =>
  ...
  String _starredAt;
  String get starredAt => _$this._starredAt;
  set starredAt(String starredAt) => _$this._starredAt = starredAt;

  RepositoryBuilder() {
    Repository._initializeBuilder(this);
  }
