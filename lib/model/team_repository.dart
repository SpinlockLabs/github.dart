...
abstract class TeamRepository implements Built<TeamRepository, TeamRepositoryBuilder> {
    ...
    static void _initializeBuilder(TeamRepositoryBuilder b) => b
        ..private = false
        ..isTemplate = false
        ..hasIssues = true
        ..hasProjects = true
    ...
    factory TeamRepository([void updates(TeamRepositoryBuilder b)]) = _$TeamRepository;
    static Serializer<TeamRepository> get serializer => _$teamRepositorySerializer;
}
