...
part 'pull_request_head_repo.g.dart';

abstract class PullRequestHeadRepo implements Built<PullRequestHeadRepo, PullRequestHeadRepoBuilder> {
    ...
    PullRequestHeadRepoOwner get owner;
    ...
    FullRepositoryPermissions get permissions;
    ...
    PullRequestHeadRepoLicense get license;
    ...
    PullRequestHeadRepo._();

    static void _initializeBuilder(PullRequestHeadRepoBuilder b) => b;

    factory PullRequestHeadRepo([void updates(PullRequestHeadRepoBuilder b)]) = _$PullRequestHeadRepo;
    static Serializer<PullRequestHeadRepo> get serializer => _$pullRequestHeadRepoSerializer;
}
