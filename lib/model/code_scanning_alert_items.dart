...
part 'code_scanning_alert_items.g.dart';

abstract class CodeScanningAlertItems implements Built<CodeScanningAlertItems, CodeScanningAlertItemsBuilder> {
    ...
    CodeScanningAlertRuleSummary get rule;
    ...
    CodeScanningAlertItems._();

    static void _initializeBuilder(CodeScanningAlertItemsBuilder b) => b;

    factory CodeScanningAlertItems([void updates(CodeScanningAlertItemsBuilder b)]) = _$CodeScanningAlertItems;
    static Serializer<CodeScanningAlertItems> get serializer => _$codeScanningAlertItemsSerializer;
}
