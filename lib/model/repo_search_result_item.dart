...
part 'repo_search_result_item.g.dart';

abstract class RepoSearchResultItem implements Built<RepoSearchResultItem, RepoSearchResultItemBuilder> {
    ...
    RepoSearchResultItem._();

    static void _initializeBuilder(RepoSearchResultItemBuilder b) => b;

    factory RepoSearchResultItem([void updates(RepoSearchResultItemBuilder b)]) = _$RepoSearchResultItem;
    static Serializer<RepoSearchResultItem> get serializer => _$repoSearchResultItemSerializer;
}
