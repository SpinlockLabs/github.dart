...
class IssuesService extends Service {
  ...
  Stream<Issue> listAll() {
    return new PaginationHelper(_github).objects("GET", "/issues", Issue.fromJSON);
  }
  ...
  Stream<Issue> listByUser() {
    return new PaginationHelper(_github).objects("GET", "/user/issues", Issue.fromJSON);
  }
  ...
  Stream<Issue> listByOrg(String org) {
    return new PaginationHelper(_github).objects("GET", "/orgs/${org}/issues", Issue.fromJSON);
  }
  ...
  Stream<User> listAssignees(RepositorySlug slug) {
    return new PaginationHelper(_github).objects("GET", 
        "/repos/${slug.fullName}/assignees", User.fromJSON);
  }
  ...
  Future<bool> isAssignee(RepositorySlug slug, String repoName) {
    return _github.request("GET", "/repos/${slug.fullName}/assignees/${repoName}")
  ...
  Stream<IssueComment> listCommentsByIssue(RepositorySlug slug, int issueNumber) {
    return new PaginationHelper(_github).objects('GET', 
        '/repos/${slug.fullName}/issues/${issueNumber}/comments', IssueComment.fromJSON);
  }
  ...
  Future<bool> deleteComment(RepositorySlug slug, int id) {
    return _github.request('DELETE', '/repos/${slug.fullName}/issues/comments/${id}')
        .then((response) => response.statusCode == StatusCodes.NO_CONTENT);
  }
  ...
  Stream<IssueLabel> listLabels(RepositorySlug slug) {
    return new PaginationHelper(_github).objects("GET", "/repos/${slug.fullName}/labels", 
        IssueLabel.fromJSON);
  }
  ...
  Future<IssueLabel> createLabel(RepositorySlug slug, String name, String color) {
    return _github.postJSON("/repos/${slug.fullName}/labels", 
        body: JSON.encode({ "name": name, "color": color }), convert: IssueLabel.fromJSON);
  }
  ...
  Future<bool> deleteLabel(RepositorySlug slug, String name) {
    return _github.request("DELETE", "/repos/${slug.fullName}/labels/${name}")
        .then((response) => response.statusCode == StatusCodes.NO_CONTENT);
  }
  ...
  Stream<IssueLabel> listLabelsByIssue(RepositorySlug slug, int issueNumber) {
    return new PaginationHelper(_github).objects("GET", 
        "/repos/${slug.fullName}/issues/${issueNumber}/labels", IssueLabel.fromJSON);
  }
  ...
  Future<List<IssueLabel>> addLabelsToIssue(RepositorySlug slug, int issueNumber, List<String> labels) {
    return _github.postJSON("/repos/${slug.fullName}/issues/${issueNumber}/labels", 
  ...
  Future<List<IssueLabel>> replaceLabelsForIssue(RepositorySlug slug, int issueNumber, List<String> labels) {
    return _github.request("PUT", "/repos/${slug.fullName}/issues/${issueNumber}/labels", 
        body: JSON.encode(labels)).then((response) {
  ...
  Future<bool> removeLabelForIssue(RepositorySlug slug, int issueNumber, String label) {
    return _github.request("DELETE", "/repos/${slug.fullName}/issues/${issueNumber}/labels/${label}")
        .then((response) => response.statusCode == StatusCodes.NO_CONTENT);
  }
  ...
  Future<bool> removeAllLabelsForIssue(RepositorySlug slug, int issueNumber) {
    return _github.request("DELETE", "/repos/${slug.fullName}/issues/${issueNumber}/labels")
        .then((response) => response.statusCode == StatusCodes.NO_CONTENT);
  }
  ...
  Stream<Milestone> listMilestones(RepositorySlug slug) {
    return new PaginationHelper(_github).objects("GET",
        "/repos/${slug.fullName}/milestones", Milestone.fromJSON);
  }
  ...
  Future<bool> deleteMilestone(RepositorySlug slug, int number) {
    return _github.request(
        "DELETE", '/repos/${slug.fullName}/milestones/${number}')
        .then((response) => response.statusCode == StatusCodes.NO_CONTENT);
  }
}
