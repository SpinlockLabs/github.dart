...
class GitService extends Service {
  ...
  Future<GitCommit> createCommit(RepositorySlug slug, CreateGitCommit commit) {
    return _github.postJSON('/repos/${slug.fullName}/git/commits', 
        convert: GitCommit.fromJSON, statusCode: StatusCodes.CREATED,
        body: commit.toJSON());
  }
  ...
  Stream<GitReference> listReferences(RepositorySlug slug, {String type}) {
    ...
    return new PaginationHelper(_github).objects('GET', path, 
  ...
  Future<GitReference> createReference(RepositorySlug slug, String ref, String sha) {
    return _github.postJSON('/repos/${slug.fullName}/git/refs', 
        convert: GitReference.fromJSON, statusCode: StatusCodes.CREATED,
  ...
  Future<GitReference> editReference(RepositorySlug slug, String ref, String sha, {bool force: false}) {
    ...
    return _github.request('PATCH', '/repos/${slug.fullName}/git/refs/${ref}', 
  ...
  Future<bool> deleteReference(RepositorySlug slug, String ref) {
    return _github.request("DELETE", "/repos/${slug.fullName}/git/refs/${ref}")
  ...
  Future<GitTag> createTag(RepositorySlug slug, CreateGitTag tag) {
    return _github.postJSON('/repos/${slug.fullName}/git/tags', 
        convert: GitTag.fromJSON, statusCode: StatusCodes.CREATED,
        body: tag.toJSON());
  }
  ...
  Future<GitTree> getTree(RepositorySlug slug, String sha, {bool recursive: false}) {
  ...
  Future<GitTree> createTree(RepositorySlug slug, CreateGitTree tree) {
    return _github.postJSON('/repos/${slug.fullName}/git/trees', 
        convert: GitTree.fromJSON, statusCode: StatusCodes.CREATED,
        body: tree.toJSON());
  }
