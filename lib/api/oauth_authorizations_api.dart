...
class OauthAuthorizationsApi {
    ...
    const OauthAuthorizationsApi(this._dio, this._serializers);
    ...
    Future<Response<Authorization>> oauthAuthorizationsCreateAuthorization({ 
        ...
        final String _path = '/authorizations';
        ...
        final bodySerializer = _serializers.serializerForType(InlineObject7) as Serializer<InlineObject7>;
        final serializedBody = _serializers.serializeWith(bodySerializer, inlineObject7);
        final jsoninlineObject7 = json.encode(serializedBody);
    ...
    Future<Response<void>> oauthAuthorizationsDeleteAuthorization(
        int authorizationId, { 
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        Map<String, dynamic> extra,
        ...
        final String _path = '/authorizations/{authorization_id}'.replaceAll('{' r'authorization_id' '}', authorizationId.toString());
    ...
    Future<Response<void>> oauthAuthorizationsDeleteGrant(
        int grantId, { 
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        Map<String, dynamic> extra,
        ...
        final String _path = '/applications/grants/{grant_id}'.replaceAll('{' r'grant_id' '}', grantId.toString());
    ...
    ///
    /// **Deprecation Notice:** GitHub will discontinue the [OAuth Authorizations API](https://docs.github.com/rest/reference/oauth-authorizations), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/apps/building-oauth-apps/authorizing-oauth-apps/#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
    Future<Response<Authorization>> oauthAuthorizationsGetAuthorization(
        int authorizationId, { 
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        Map<String, dynamic> extra,
    ...
    ///
    /// **Deprecation Notice:** GitHub will discontinue the [OAuth Authorizations API](https://docs.github.com/rest/reference/oauth-authorizations), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/apps/building-oauth-apps/authorizing-oauth-apps/#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
    Future<Response<ApplicationGrant>> oauthAuthorizationsGetGrant(
        int grantId, { 
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        Map<String, dynamic> extra,
        ...
        return _dio.request<dynamic>(
            ...
            final serializer = _serializers.serializerForType(ApplicationGrant) as Serializer<ApplicationGrant>;
            final data = _serializers.deserializeWith<ApplicationGrant>(
                serializer,
                response.data is String ? jsonDecode(response.data as String) : response.data,
            );

            return Response<ApplicationGrant>(
                data: data,
                headers: response.headers,
                isRedirect: response.isRedirect,
                request: response.request,
    ...
    Future<Response<Authorization>> oauthAuthorizationsGetOrCreateAuthorizationForApp(
        String clientId, { 
        ...
        final String _path = '/authorizations/clients/{client_id}'.replaceAll('{' r'client_id' '}', clientId.toString());
        ...
        final bodySerializer = _serializers.serializerForType(InlineObject8) as Serializer<InlineObject8>;
        final serializedBody = _serializers.serializeWith(bodySerializer, inlineObject8);
        final jsoninlineObject8 = json.encode(serializedBody);
    ...
    Future<Response<Authorization>> oauthAuthorizationsGetOrCreateAuthorizationForAppAndFingerprint(
        String clientId,
        String fingerprint, { 
        ...
        final String _path = '/authorizations/clients/{client_id}/{fingerprint}'.replaceAll('{' r'client_id' '}', clientId.toString()).replaceAll('{' r'fingerprint' '}', fingerprint.toString());
        ...
        final bodySerializer = _serializers.serializerForType(InlineObject9) as Serializer<InlineObject9>;
        final serializedBody = _serializers.serializeWith(bodySerializer, inlineObject9);
        final jsoninlineObject9 = json.encode(serializedBody);
    ...
    ///
    /// **Deprecation Notice:** GitHub will discontinue the [OAuth Authorizations API](https://docs.github.com/rest/reference/oauth-authorizations), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/apps/building-oauth-apps/authorizing-oauth-apps/#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
    Future<Response<BuiltList<Authorization>>> oauthAuthorizationsListAuthorizations({ 
        int perPage,
        int page,
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        ...
        return _dio.request<dynamic>(
            ...
            const type = FullType(BuiltList, [FullType(Authorization)]);
            final data = _serializers.deserialize(
                response.data is String
                ? jsonDecode(response.data as String)
                : response.data,
                specifiedType: type,
            ) as BuiltList<Authorization>;

            return Response<BuiltList<Authorization>>(
                data: data,
                headers: response.headers,
                isRedirect: response.isRedirect,
                request: response.request,
    ...
    Future<Response<BuiltList<ApplicationGrant>>> oauthAuthorizationsListGrants({ 
        int perPage,
        int page,
        CancelToken cancelToken,
        Map<String, dynamic> headers,
        ...
        final String _path = '/applications/grants';
        ...
        return _dio.request<dynamic>(
            ...
            const type = FullType(BuiltList, [FullType(ApplicationGrant)]);
            final data = _serializers.deserialize(
                response.data is String
                ? jsonDecode(response.data as String)
                : response.data,
                specifiedType: type,
            ) as BuiltList<ApplicationGrant>;

            return Response<BuiltList<ApplicationGrant>>(
                data: data,
                headers: response.headers,
                isRedirect: response.isRedirect,
                request: response.request,
    ...
    Future<Response<Authorization>> oauthAuthorizationsUpdateAuthorization(
        int authorizationId, { 
        ...
        final bodySerializer = _serializers.serializerForType(InlineObject10) as Serializer<InlineObject10>;
        final serializedBody = _serializers.serializeWith(bodySerializer, inlineObject10);
        final jsoninlineObject10 = json.encode(serializedBody);
